#ifndef FILE_LIN_PIEZO_COUPLING_3D
#define FILE_LIN_PIEZO_COUPLING_3D
...
namespace CoupledField {
  ...
  //! Class describing the ADB operator for piezoelectric coupling in 3D
  ...
  //! piezoelectric coupling operator for a 3D simulation.
  class linPiezoCoupling3D : public ADBInt {
  ...
  public:
    ...
    //! Default constructor
    linPiezoCoupling3D() {
      ENTER_FCN( "linPiezoCoupling3D::linPiezoCoupling3D" );
    }
