...
namespace CoupledField
{
  ...
  template<Integer dim>
  void GridCFS<dim> :: GetCoordinateNode(const Integer inode,
					 const Integer numlevel,
					 Point<dim> & rfPoint) 
  {
    ENTER_FCN( "GridCFS::GetCoordinateNode" );
  ...
  void GridCFS<dim> :: GetCoordNodesElem(const Vector<Integer> connect,
					 ...
					 const Integer level)
  {
    ENTER_FCN( "GridCFS::GetCoordinateNodesElem" );
    Integer k;
  ...
  void GridCFS<dim> :: GetCoordNodesElemMat(const Vector<Integer> connect,
					    ...
					    const Integer level)
  {
    ENTER_FCN( "GridCFS::GetCoordinateNodesElemMat" );
  ...
  template<Integer dim> GridCFS<dim>::~GridCFS() 
  {
    ENTER_FCN( "GridCFS::~GridCFS" );
