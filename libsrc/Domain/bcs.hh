...
namespace CoupledField
{
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      \param lev index for hierarchy in multilevel method
    */
    StdVector<Elem*>& getEdgesBC(const std::string color, const Integer lev=-1);
    ...
    /*!
      ...
      \param lev index for hierarchy in multilevel method
    */
    StdVector<Elem*>& getFacesBC(const std::string color, const Integer lev=-1);
    ...
    */
    StdVector<Elem*> getNeighElemsForSurfaces(const std::string color, const Integer lev=-1);
  ...
  private:
    ...
    StdVector<std::string> levels_;            //!< stores all names of boundary nodes
    StdVector<std::string> color_edges_;       //!< stores all names of 1D interfaces
    StdVector<std::string> color_faces_;       //!< stores all names of 2D interfaces
