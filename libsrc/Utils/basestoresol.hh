...
public:
  ...
  virtual void SetNumDofs(const Integer dof,
			  const SolutionType sol = NO_SOLUTION_TYPE) = 0;
  ...
  //!
  inline Integer GetDof(const SolutionType sol = NO_SOLUTION_TYPE) const
  {
  ...
  virtual void GetSolVector(const SolutionType type, 
