...
namespace CoupledField
{
  ...
  */
  ...
  public:
    ...
    MHMaterialData(StdVector<BaseMaterial*>& ptMaterial);

    //MHMaterialData(const BaseMaterial& mat);
    
    ~MHMaterialData();
    
    void updateMaterialData(Vector<Complex> & parameter, StdVector<BaseMaterial*> ptMaterial);
    // Domain * ptDomain;
    ...
    StdVector<BaseMaterial*> ptMaterial_; 
