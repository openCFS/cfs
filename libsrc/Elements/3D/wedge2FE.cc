...
void Wedge2FE::SetCornerCoords()
{
  ...
  LCornerCoords_[1][13] =  0.5;
  LCornerCoords_[2][13] =  0.5;

  LCornerCoords_[0][14] =  0.0;
  LCornerCoords_[1][14] =  0.5;
  LCornerCoords_[2][14] =  0.5;
				       ...
				       const Vector<Double> & LCoord)
{
  ...
  LDeriv[11][2] =   2*LCoord[2] * (1 + 2*LCoord[2]) * LCoord[1] * (1 - LCoord[0] - LCoord[1]); 
