...
void Quad2FE::GetLocalIntPoints4Surface(const StdVector<Integer> & surfConnect,
					...
					Vector<Double> & volIntPoint)
{
  ...
  switch(indexSum)
    {
    case 8:
      // Edge[1,5,2] is common
      volIntPoint[0] = surfIntPoint[0];
      volIntPoint[1] = 1;
      break;

    case 14:
      // Edge[4,7,3] is common
      volIntPoint[0] = surfIntPoint[0];
      volIntPoint[1] = 1;
      break;

    case 13:
      // Edge[1,8,4] is common
      volIntPoint[0] = 1;
      volIntPoint[1] = surfIntPoint[0];
      break;

    case 11:
      // Edge[2,6,3] is common
      volIntPoint[0] = 1;
      volIntPoint[1] = surfIntPoint[0];
      break;

    default:
      errMsg = "Quad2FE::GetLocalIntPoints4Surface: surface and volume element ";
