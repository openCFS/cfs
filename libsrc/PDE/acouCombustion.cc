...
namespace CoupledField
{
  ...
  AcouCombustionNoise::AcouCombustionNoise(Grid *aptgrid, TimeFunc *aptTimeFunc, WriteResults *aptOut)
    :AcousticPDE(aptgrid, aptTimeFunc, aptOut)
  {
    ...
    std::string cplRegion;
    params->Get("coupledRegion",coupledRegionNames[0], "combustionData");
    ...
    params->Get("fileName",filenameCFD_, "combustionData");
    params->Get("varSpeedOfSound",varSpeedOfSound, "combustionData");
    params->Get("ReynoldStress",srcReynoldStress, "combustionData");
    params->Get("momentum",srcMomentum, "combustionData");
    params->Get("chemical",srcChemical, "combustionData");
    params->Get("densityDeriv2",srcDensityDeriv2, "combustionData");
    params->Get("heatRelease",srcHeatRelease, "combustionData");
    params->Get("gasConstDeriv2",srcGasConstDeriv2, "combustionData");
    params->Get("shearTerm",srcShearTerm, "combustionData");
    ...
    params->Get("numDataInCFD", numDataInCFD_, "combustionData");   
	...
	srcType_ = SHEARTERM;
      ...
      Error("Ckeck your xml-file according to the choice of your source terms",
	    __FILE__,__LINE__);
    }
  ...
  void AcouCombustionNoise::ComputeRHS(const Double atime)
  {
    ...
    params->Get("xfmin",xfmin, "combustionData");
    params->Get("yfmin",yfmin, "combustionData");
    params->Get("xfmax",xfmax, "combustionData");
    params->Get("yfmax",yfmax, "combustionData");
    params->Get("facrampXmin",facRampXmin, "combustionData");
    params->Get("facrampYmin",facRampYmin, "combustionData");
    params->Get("facrampXmax",facRampXmax, "combustionData");
    params->Get("facrampYmax",facRampYmax, "combustionData");
    ...
    if (dim_==3) {
      params->Get("zfmin",zfmin, "combustionData");
      params->Get("zfmax",zfmax, "combustionData");
      params->Get("facrampZmin",facRampZmin, "combustionData");
      params->Get("facrampZmax",facRampZmax, "combustionData");
...
// 	  }
      ...
      Error("Currently harmonic case not implemented!",__FILE__,__LINE__);
    }    
