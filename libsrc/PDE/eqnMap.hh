...
namespace CoupledField {
  ...
  public:
    ...
    typedef std::map<ResultDof, StdVector<shared_ptr<EntityList> > > ResultEntityMap;
    ...
    //! Add a new result
    void AddResult( ResultDof& result, 
