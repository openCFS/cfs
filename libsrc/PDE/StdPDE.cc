...
namespace CoupledField {
  ...
  void StdPDE::GetNodesOfSubdomain()
  {
    ENTER_FCN( "StdPDE::GetNodesOfSubdomain" );
    UInt i, j;
    UInt localPDENode;
  ...
  void StdPDE::SetupNodesSubdomainsMapping()
  {
    ENTER_FCN( "StdPDE::SetupNodesSubdomainsMapping" );
