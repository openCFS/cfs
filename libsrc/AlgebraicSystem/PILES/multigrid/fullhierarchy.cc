...
RFullHierarchy :: RFullHierarchy(BaseParameter & param, Integer asize, Integer aoffset, Integer anumrhs)
  : BaseHierarchy(param, asize, aoffset, anumrhs)
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::RFullHierarchy" << endl;
#endif

}
  
RFullHierarchy :: ~RFullHierarchy()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::~RFullHierarchy" << endl;
#endif
...
void RFullHierarchy :: Init()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::Init" << endl;
#endif
...
void RFullHierarchy :: DeleteAuxMemory()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::DeleteAuxMemory" << endl;
#endif
...
void RFullHierarchy :: MakeSmoother()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::MakeSmoother" << endl;
#endif
  ...
  switch (param->GetSmoothingType())
	...
	{
	  node[level].smooth = new RFullFastGSSmoother(*param,fsize_sys,numrhs);
	}
      else
	{
	  node[level].smooth = new RFullGSSmoother(*param,fsize_sys,numrhs);
	}
      break;
...
void RFullHierarchy :: MakeCoarsening()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::MakeCoarsening" << endl;
#endif
...
void RFullHierarchy :: MakeSysTransfer()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::MakeSysTransfer" << endl;
#endif
...
void RFullHierarchy :: MakeAuxTransfer()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::MakeAuxTransfer" << endl;
#endif
...
void RFullHierarchy :: MakeSysMatrix()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::MakeSysMatrix" << endl;
#endif

  dir_sys = 0;

  node[level-1].sysmat = new RFullMatrix(csize_sys, dir_sys);
}

void RFullHierarchy :: MakeAuxMatrix()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::MakeAuxMatrix" << endl;
#endif
...
void RFullHierarchy :: MakeVector()
{
#ifdef TRACE
  (*trace) << "entering RFullHierarchy::MakeVector" << endl;
#endif
