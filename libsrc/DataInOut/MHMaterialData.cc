...
namespace CoupledField
{
  ...
  MHMaterialData::MHMaterialData(MaterialData * ptMaterial)
  {
    ENTER_FCN("MHMaterialData::MHMaterialData");
  
    ptMaterial_ = ptMaterial;
  ...
  MHMaterialData::~MHMaterialData()
  {
    ...
    void MHMaterialData::updateMaterialData(Vector<Complex> & parameter, MaterialData * ptMaterial){
