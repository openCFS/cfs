...
#include "AuldParamHandler.hh"

namespace CoupledField
{

  AuldParamHandler::AuldParamHandler(const Char* const afilename)
  {
#ifdef TRACE
    (*trace) << "entering AuldParamHandler::AuldParamHandler" << std::endl;
#endif
  ...
  AuldParamHandler::~AuldParamHandler()
  {
#ifdef TRACE
    (*trace) << " entering AuldParamHandler::~AuldParamHandler " << std::endl;
#endif
  ...
  void AuldParamHandler::get(const std::string keyword, std::string & val,
  ...
  void AuldParamHandler::get(const std::string keyword, Integer & val,
			     const std::string section,
			     const std::string subsection,
			     const std::string subsubsection)
  {
  ...
  void AuldParamHandler::get(const std::string keyword, Double & val,
			     const std::string section,
			     const std::string subsection, 
			     const std::string subsubsection)
  {
  ...
  void AuldParamHandler::get2(const std::string keyword, Double & val,
			      std::string & fncname, const std::string section,
			      const std::string subsection,
			      const std::string subsubsection)
  {
    std::string::size_type pos,pos1=0;
  ...
  void AuldParamHandler::getCoilData(coilDefStruct& acoil,
				     const std::string section,
				     const std::string subsection)
  {
    std::string::size_type pos,pos1=0;
  ...
  Boolean AuldParamHandler::ifget(const std::string keyword,
				  std::string & val, const std::string section,
				  const std::string subsection,
				  const std::string subsubsection)
  {
    std::string::size_type pos,pos1=0;
  ...
  Boolean AuldParamHandler::ifget(const std::string keyword, Integer & val,
				  const std::string section,
				  const std::string subsection,
				  const std::string subsubsection)
  {
  ...
  Boolean AuldParamHandler::ifget(const std::string keyword, Double & val,
				  const std::string section,
				  const std::string subsection, 
				  const std::string subsubsection)
  {
  ...
  Boolean AuldParamHandler::get_option(const std::string keyword,
				       const std::string section,
				       const std::string subsection,
				       const std::string subsubsection)
  {
#ifdef TRACE
    (*trace) << " entering AuldParamHandler::get_option " << std::endl;
#endif
  ...
  AuldParamHandler::getpos(const std::string keyword,
  ...
  std::string::size_type
  AuldParamHandler::getsectionpos(const std::string keyword,
				  const std::string::size_type startpos,
				  Boolean writeErr)
  {
    std::string::size_type help,pos=std::string::npos;
  ...
  std::string::size_type
  AuldParamHandler::getsubsectionpos(const std::string keyword,
				     const std::string::size_type startpos,
				     Boolean writeErr)
  {
    std::string::size_type help,pos=std::string::npos;
  ...
  // #ifdef __GNUC__
  // template void AuldParamHandler::get(const std::string , std::string &, const std::string, const std::string, const std::string);
  // template void AuldParamHandler::get(const std::string , Integer &, const std::string, const std::string, const std::string);
  // template void AuldParamHandler::get(const std::string , Double &,const std::string, const std::string, const std::string);

  // template Boolean AuldParamHandler::ifget(const std::string , std::string &, const std::string, const std::string, const std::string);
  // template Boolean AuldParamHandler::ifget(const std::string , Integer &,const std::string, const std::string, const std::string);
  // template Boolean AuldParamHandler::ifget(const std::string , Double &, const std::string, const std::string, const std::string);
  // #endif


  void AuldParamHandler::getsubdom(std::vector<std::string> & subdoms)
  {
  ...
  void AuldParamHandler::getsubdompde(std::vector<std::string> & subdoms,
				      const std::string section)
  {
  ...
  void AuldParamHandler::getlist(std::vector<Integer> & hist,
  ...
  void AuldParamHandler::getlist( const std::string seekexp,
  ...
  void AuldParamHandler::getliststr( const std::string seekexp,
  ...
  void AuldParamHandler::getstr( const std::string seekexp, std::string &str,
				 const std::string section,
				 const std::string subsection)
  {
    std::string::size_type pos=0;
  ...
  Boolean AuldParamHandler::ifgetliststr( const std::string seekexp,
					  std::vector<std::string> & stlist,
					  const std::string section, 
					  const std::string subsection)
  {
    ...
    if (checkpos==std::string::npos)
      {
	std::string message = "In command " + seekexp +
	  " the delimiter non is missing";
  ...
  void AuldParamHandler::open_file()
  {
  ...
  void AuldParamHandler::error(const std::string keyword) const
  {
  ...
  void AuldParamHandler::check(const std::string value,
  ...
  void AuldParamHandler::getVal_Fnc(const std::string::size_type startpos,
