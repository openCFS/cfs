...
namespace CoupledField
{
  ...
  //! This class is the original parameter handling routine of CFS++. It was
  //! formerly denoted as ConfFile. It is provided for backward compatibility
  //! and allows using traditional CFS++ parameter files.
  class AuldParamHandler : public BaseParamHandler
  {

  public:

    //! constructor with name of conf-file
    AuldParamHandler(const Char* const afilename);
    ...
    //! \param section name of a section in which keyword there is. can be
    //!        omitted.
    //! \param subsection name of a subsection of the section in which keyword
    //!        there is. can be omitted.
    ...
    //! get from conf-file value(integer, double or string), if this value is
    //! specified there
    //! \param keyword keyword for the value in config-file
    //! \param val return value from config-file
    ...
    Boolean ifget(const std::string keyword, std::string & val,
		  const std::string section="",
		  const std::string subsection="", 
		  const std::string subsubsection="");
    Boolean ifget(const std::string keyword, Integer & val,
		  const std::string section="",
		  const std::string subsection="", 
		  const std::string subsubsection="");
    Boolean ifget(const std::string keyword, Double & val,
		  const std::string section="",
		  const std::string subsection="", 
		  const std::string subsubsection="");
    ...
    //! \param subsection name of a subsection of the section in which keyword
    //! there is. can be omitted.
    //! \param subsection etc. can be omitted.
    void getCoilData(coilDefStruct &acoil, const std::string section,
		     const std::string subsection);

    //! use only in cases when value of keyword is yes/no. if the keyword is
    //! absent in file, then return FALSE
    //! \param keyword keyword for the value in config-file
    //! \param section name of a section in which keyword there is
    //! \param subsection name of a subsection of the section in which keyword
    //! there is
    //! \param subsubsection etc.
    Boolean get_option(const std::string keyword,
		       const std::string section="",
		       const std::string subsection = "",
		       const std::string subsubsection = "");
    ...
    //! \param hist list of returned values
    //! \param seekexp keyword
    //! \param section name of a section in which keyword is there.
    //!                can be omitted
    //! \param subsection name of a subsection of the section in which keyword
    //!                is there. can be omitted
    void getlist(const std::string seekexp, std::vector<Double> & hist,
		 const std::string section="",
		 const std::string subsection="");
    ...
    //! \param subsection name of a subsection of the section in which keyword
    //!                is there. can be omitted
    void getstr(const std::string seekexp, std::string &str,
		const std::string section="", const std::string subsection="");

    //! get list of string-values(for ex. pdes) for a keyword, if this keyword
    //! is in config-file.
    //! \param seekexp keyword
    //! \param pdes vector with returned list of string
    //! \param section name of a section in which keyword is there.
    ...
    //! \param subsection name of a subsection of the section in which keyword
    //!                is there. can be omitted
    Boolean ifgetliststr(const std::string seekexp,
    ...
    void getsubdompde(std::vector<std::string> & subdoms,
  ...
  protected:
    ...
    void getVal_Fnc( const std::string::size_type startpos, Double &val,
		     std::string & name);
    ...
    getsectionpos(const std::string keyword,
		  const std::string::size_type startpos=0,
		  Boolean writeErr=TRUE);

    //! get position of subsection in conf-file
    std::string::size_type
    getsubsectionpos(const std::string keyword,
		     const std::string::size_type startpos=0,
		     Boolean writeErr=TRUE);
  ...
  private:
    ...
    //! store list of all subdomains. we need this for checking that subdomains
    //! for PDE are valid
