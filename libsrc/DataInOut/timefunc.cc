  ...
  for (Integer i=0; i< maxnumTF_; i++)
	...
	{	  
	  ...
	  if (buf[0] != '#' || buf[0] != '%' || buf[0] != '!') 
	    {
	      timefile.seekg(- buf.size(),std::ios::cur); // rewind
