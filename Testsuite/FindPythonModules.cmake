...
# see https://cmake-basis.github.io/download.html#license.
#
...
# check fo the optional ones
set (PythonModules_OPTIONAL_FOUND TRUE)
foreach (_PythonModules_MODULE ${PythonModules_FIND_OPTIONAL_COMPONENTS})
  if (NOT PythonModules_${_PythonModules_MODULE}_FOUND )
    set(PythonModules_OPTIONAL_FOUND FALSE)
  endif()
endforeach ()
