...
Just configure with setting `CFS_INSTALL_DIR` to the path of an CFS installation and using the `Testsuite` directory as the source, e.g.
```shell
cmake -DCFS_INSTALL_DIR=/path/to/cfs/build /path/to/CFS/Testsuite
```
