...
This test checks if the grid conversion using the CGNS Reader works as expected. Therefore, dummy simulation and material xml file are used and the grid conversion only is executed using `cfs -gG ShellElementConversion_CGNS`.
