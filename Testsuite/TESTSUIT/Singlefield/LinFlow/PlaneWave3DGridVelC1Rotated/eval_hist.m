...
f_path_S1_2D = '../PlaneWave2DGridVelC1/history/PlaneWave2DGridVelC1-fluidMechPressure-node-201-S1.hist';
f_path_S2_2D = '../PlaneWave2DGridVelC1/history/PlaneWave2DGridVelC1-fluidMechPressure-node-101-S2.hist';
f_path_S1 = 'history/PlaneWave3DGridVelC1Rotated-fluidMechPressure-node-1-S1.hist';
f_path_S2 ='history/PlaneWave3DGridVelC1Rotated-fluidMechPressure-node-203-S2.hist'; %nur xyz
...
title('Comparison of 2D and 3D testcase (C1)')
...
set(gca,'fontsize',real_fs)
grid on
title('soundPressure of 3D testcase at point S1 and S2 (C1)')
...
k_analytic_2D = omega*(v_g+sqrt(v_g^2+4*c0^2))/(2*c0^2);
