...
// gmsh gmsh_sphere.geo -3 -v 0 -format msh -order 1 -o gmsh_Abc3d.msh

// Frontal Delaunay 3D algorithm
Mesh.Algorithm3D = 5;
...
Physical Surface("abc") = {60,61,65,69,71,75,79,83};
Physical Volume("acoust3d") = {1000};
