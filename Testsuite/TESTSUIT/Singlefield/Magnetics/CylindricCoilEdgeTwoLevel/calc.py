...
if exists("history/CylindricCoilEdgeTwoLevel-magFluxDensity-hist-1.hist"):
    b_edge_hist = loadtxt("history/CylindricCoilEdgeTwoLevel-magFluxDensity-hist-1.hist")
...
wFiles = ["history/CylindricCoilEdgeTwoLevel-magEnergy-region-air.hist",
           "history/CylindricCoilEdgeTwoLevel-magEnergy-region-coil.hist",
           "history/CylindricCoilEdgeTwoLevel-magEnergy-region-core.hist"]
