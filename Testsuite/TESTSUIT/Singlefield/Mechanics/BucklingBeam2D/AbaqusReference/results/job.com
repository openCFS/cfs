...
options = {
    ...
    'input':'E:\\zu ordnen\\Studium\\Seminararbeit Mechatronische Systeme\\testcase_buckling_beam\\Abaqus\\beam_2D\\Model_Input_File',
    'inputFormat':INP,
    'job':'job',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'listener_name':'DESKTOP-SN9OMVL',
    'listener_resource':'13192',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    'memory':'90%',
    'message':None,
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\Matthias\\AppData\\Local\\Temp',
    'tracer':OFF,
    'unsymm':OFF,
    'visco':OFF,
    'xplSelect':OFF,
