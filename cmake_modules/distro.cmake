...
FILE(WRITE "${CFS_BINARY_DIR}/CMakeFiles/distro_out.cmake" "${DISTRO_OUT}")
INCLUDE("${CFS_BINARY_DIR}/CMakeFiles/distro_out.cmake")
...
LIST(FIND SUPPORTED_DISTROS ${CFS_DISTRO} DISTRO_FOUND)
IF(DISTRO_FOUND LESS 0)
  MESSAGE(FATAL_ERROR "Your distro ${CFS_DISTRO} is currently not supported. Please make the necessary modifications in cmake_modules.")
ENDIF(DISTRO_FOUND LESS 0)
...
IF(CFS_DISTRO STREQUAL "UBUNTU" OR
   CFS_DISTRO STREQUAL "LINUXMINT")
...
ENDIF(CFS_DISTRO STREQUAL "UBUNTU" OR
      CFS_DISTRO STREQUAL "LINUXMINT")

IF(CFS_DISTRO STREQUAL "FEDORA" OR
   CFS_DISTRO STREQUAL "REDHAT" OR
   CFS_DISTRO STREQUAL "RHEL" OR
   CFS_DISTRO STREQUAL "CENTOS" OR
   CFS_DISTRO STREQUAL "ORACLE")
