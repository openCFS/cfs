...
IF(CFS_ARCH STREQUAL "I386")
  IF(MKL_FOUND)
    ...
    IF(EXISTS "${MKL_ROOT_DIR}/../lib/32/libiomp5.a")
      SET(MKL_LIB_IOMP "${MKL_ROOT_DIR}/../lib/32/libiomp5.a")
    ENDIF(EXISTS "${MKL_ROOT_DIR}/../lib/32/libiomp5.a")
    IF(EXISTS "${MKL_ROOT_DIR}/../lib/32/libguide.a")
      SET(MKL_LIB_GUIDE "${MKL_ROOT_DIR}/../lib/32/libguide.a")
    ENDIF(EXISTS "${MKL_ROOT_DIR}/../lib/32/libguide.a")
