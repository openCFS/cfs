...
macro(set_precompiled_pckg_file)
  ...
  if(${CFS_DEPS_PRECOMPILED} AND NOT EXISTS "${PRECOMPILED_PCKG_FILE}")
    ...
    if(EXISTS "${PRECOMPILED_PCKG_FILE}")
      message(STATUS "  ... but file exits")
    endif()
    if(EXISTS "${CFS_DEPS_CACHE_DIR}/precompiled")
      message(STATUS "  ... precompiled dir exists")
    endif()
    if(EXISTS "${CFS_DEPS_CACHE_DIR}")
      message(STATUS "  ... deps cache dir exists")
    endif()
    get_filename_component(_NAME "${PRECOMPILED_PCKG_FILE}" NAME)
    find_file(_FIND "${_NAME}" "${CFS_DEPS_CACHE_DIR}" "${CMAKE_BINARY_DIR}")
    message(STATUS "  ... found: ${_FIND}")
  endif()
endmacro()
