...
# set standard variables for head-only dependencies. See set_standard_variables()
macro(set_header_only_standard_variables)
  assert_set(PACKAGE_NAME)
  assert_unset(PACKAGE_LIBRARY)
  assert_set(PRECOMPILED_PCKG_FILE)
  ...
  # delete <package>_INCLUDE_DIR, 
  # note that this will directly trigger setting it with new values as it calls cmake!
  # you might usually also want to call the clean-<package> target   
  add_custom_target(overwrite-${PACKAGE_NAME} cmake . -U ${_UPPER_PACKAGE_NAME}_INCLUDE_DIR
     COMMENT "delete cached ${PACKAGE_NAME}_INCLUDE_DIR")
endmacro()
