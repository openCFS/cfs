...
set(DEPS_VER "-e") # set to "-a", "-b", when dependency changed with same PACKAGE_VER. Reset to "" with new PACKAGE_VER.
...
elseif(USE_BLAS_LAPACK STREQUAL "ACCELERATE")
  # Apple's legacy BLAS is f2c based, a REAL function returns a double (SCNRM2 in libnum.f90).
  # -ff2c implies -fsecond-underscore which would rename zfeast_scsrgvx_ -> zfeast_scsrgvx__
  set(ADDITIONAL_FORTRAN_ARGS "${ADDITIONAL_FORTRAN_ARGS} -ff2c -fno-second-underscore")
endif()
