...
# HDF5 >= 1.14 uses StrStrIA (H5system.c) -> needs Windows shlwapi.lib.
if(WIN32)
  set(HDF5_LIBRARY ${HDF5_LIBRARY} shlwapi)
endif()
...
set(DEPS_ARGS
  ...
  -DHDF5_BUILD_CPP_LIB:BOOL=OFF # we got rit of the outdated C++ interface
  ...
  -DHDF5_ENABLE_NONSTANDARD_FEATURE_FLOAT16:BOOL=OFF # fails on clang in pipeline
