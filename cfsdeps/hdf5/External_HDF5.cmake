...
#-------------------------------------------------------------------------------
IF(WIN32)
  SET(HDF5_LIBRARY_RELEASE ${CFS_BINARY_DIR}/${LIB_SUFFIX}/${CFS_ARCH_STR}/hdf5)
  SET(HDF5_CPP_LIBRARY_RELEASE ${CFS_BINARY_DIR}/${LIB_SUFFIX}/${CFS_ARCH_STR}/hdf5_cpp)
  SET(HDF5_LIBRARY_DEBUG ${CFS_BINARY_DIR}/${LIB_SUFFIX}/${CFS_ARCH_STR}/hdf5_D)
  SET(HDF5_CPP_LIBRARY_DEBUG ${CFS_BINARY_DIR}/${LIB_SUFFIX}/${CFS_ARCH_STR}/hdf5_cpp_D)
  SET(HDF5_LT_LIBRARY_RELEASE ${CFS_BINARY_DIR}/${LIB_SUFFIX}/${CFS_ARCH_STR}/hdf5_hl)
  SET(HDF5_LT_CPP_LIBRARY_RELEASE ${CFS_BINARY_DIR}/${LIB_SUFFIX}/${CFS_ARCH_STR}/hdf5_hl_cpp)
  SET(HDF5_LT_LIBRARY_DEBUG ${CFS_BINARY_DIR}/${LIB_SUFFIX}/${CFS_ARCH_STR}/hdf5_hl_D)
  SET(HDF5_LT_CPP_LIBRARY_DEBUG ${CFS_BINARY_DIR}/${LIB_SUFFIX}/${CFS_ARCH_STR}/hdf5_hl_cpp_D)
ELSE(WIN32)
