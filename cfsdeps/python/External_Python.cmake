...
set(python_prefix ${CMAKE_CURRENT_BINARY_DIR}/cfsdeps/${proj})
set(python_build ${python_prefix}/src/${proj})
...
elseif(UNIX)
  ...
  SET(TEMPL "${CFS_SOURCE_DIR}/cfsdeps/python/python_patch_step.cmake.in")
  SET(PATCH_STEP "${python_prefix}/python_patch_step.cmake")
  CONFIGURE_FILE("${TEMPL}" "${PATCH_STEP}" @ONLY) 
...
#    @ONLY)
  ...
  SET(TEMPL "${CFS_SOURCE_DIR}/cfsdeps/python/python_configure_step.cmake.in")
  SET(CONF_STEP "${python_prefix}/python_configure_step.cmake")
  CONFIGURE_FILE("${TEMPL}" "${CONF_STEP}" @ONLY) 
...
#    @ONLY)
  ...
  SET(TEMPL "${CFS_SOURCE_DIR}/cfsdeps/python/python_make_step.cmake.in")
  SET(MAKE_STEP "${python_prefix}/python_make_step.cmake")
  CONFIGURE_FILE("${TEMPL}" "${MAKE_STEP}" @ONLY) 
...
#    @ONLY)
  ...
  SET(TEMPL "${CFS_SOURCE_DIR}/cfsdeps/python/python_install_step.cmake.in")
  SET(INST_STEP "${python_prefix}/python_install_step.cmake")
  CONFIGURE_FILE("${TEMPL}" "${INST_STEP}" @ONLY) 
