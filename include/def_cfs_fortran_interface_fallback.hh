...
#define snkera CFS_FORTRAN_INTERFACE_GLOBAL(snkera, SNKERA)
#define snlog CFS_FORTRAN_INTERFACE_GLOBAL(snlog, SNLOG)
#define snlog2 CFS_FORTRAN_INTERFACE_GLOBAL(snlog2, SNLOG2)
#define sqlog CFS_FORTRAN_INTERFACE_GLOBAL(sqlog, SQLOG)
