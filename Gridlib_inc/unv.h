...
friend class dataset;
    ...
    int goto_pos(const streampos position) const;
    int find_delimiter(int* status);
    int find_next_set(streampos* position, int* status);
...
protected:
    ...
    int get_in_stream(ifstream** in_stream) const;
    int get_out_stream(ofstream** out_stream) const;
