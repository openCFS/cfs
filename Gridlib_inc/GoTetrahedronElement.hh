...
{
public: 
  GoTetrahedronElement() { this_ = new GoTetrahedronElementBase<float>; }
  GoTetrahedronElement(GoTetrahedronElementBase<float> *t) : this_(t) {}

  virtual ~GoTetrahedronElement() { delete this_; }

  // Operations on vertices of the geometry object
  virtual void setVertex(int i, GoVertex<float> *v) {
    ::setVertex<GoTetrahedronElementBase<float>,float> (this_,i,v);
  }
  virtual GoVertex<float> *getVertex(int i) const {
    return ::getVertex<GoTetrahedronElementBase<float>,float> (this_,i);
  }
  virtual int findVertex(GoVertex<float> *v) const {
    return ::findVertex<GoTetrahedronElementBase<float>,float> (this_,v);
  }
  virtual GoVertex<float> *otherVertex(GoGeometryElement<float> *f) const {
    return ::otherVertex<GoTetrahedronElementBase<float>,float> (this_,f);
  }
  ...
  virtual GoGeometryElement<float> *otherFace(GoVertex<float> *v) const {
    return ::otherFace<GoTetrahedronElementBase<float>,float> (this_,v);
  }

  // The face normal
  virtual void computeNormal() {
    ::computeNormal<GoTetrahedronElementBase<float>,float> (this_);
  }
  virtual GbVec3<float> getNormal() const {
    return ::getNormal<GoTetrahedronElementBase<float>,float> (this_);
  }
  virtual void setNormal(const GbVec3<float>& n) {
    ::setNormal<GoTetrahedronElementBase<float>,float> (this_,n);
  }

  // The layout of the object
  virtual GbVec3<float> getOrigin() const {
//    return ::getOrigin<GoTetrahedronElementBase<float>,float> (this_);
    return GbVec3<float>::ZERO;
  }
  virtual GbVec3<float> getEdge(int i) const {
//    return ::getEdge<GoTetrahedronElementBase<float>,float> (this_,i);
    return GbVec3<float>::ZERO;
  }
  ...
  virtual void setFlag(GbGeoStatusFlag f) {
    ::setFlag<GoTetrahedronElementBase<float>,float> (this_,f);
  }
  virtual void delFlag(GbGeoStatusFlag f) {
    ::delFlag<GoTetrahedronElementBase<float>,float> (this_,f);
  }
  virtual GbBool testFlag(GbGeoStatusFlag f) const {
    return ::testFlag<GoTetrahedronElementBase<float>,float> (this_,f);
  }
...
//  virtual int getNumSplits() const;
  ...
  virtual void setId(int i) {
    ::setId<GoTetrahedronElementBase<float>,float> (this_,i);
  }
  virtual int getId() const {
    return ::getId<GoTetrahedronElementBase<float>,float> (this_);
  }

  // modification operations on the object
  virtual GbBool subdivide(const GbOracle &op) {
    if (op())
      return ::subdivide<GoTetrahedronElementBase<float>,float> (this_);
    else
      return false;
  }
  ...
  virtual void setPartition(int i) {
    ::setPartition<GoTetrahedronElementBase<float>,float> (this_,i);
  }
  virtual int getPartition() const {
    return ::getPartition<GoTetrahedronElementBase<float>,float> (this_);
  }

  // The neighboring face objects
  virtual void setNeighbour(int i, GoGeometryElement<float> *face) {
    ::setNeighbour<GoTetrahedronElementBase<float>,float> (this_,i,face);
  }
  virtual void setNeighbour(GoGeometryElement<float> *face) {
    ::setNeighbour<GoTetrahedronElementBase<float>,float> (this_,face);
  }
  virtual GoGeometryElement<float> *getNeighbour(int i) const {
    return ::getNeighbour<GoTetrahedronElementBase<float>,float> (this_,i);
  }
  virtual int findNeighbour(GoGeometryElement<float> *face) {
    return ::findNeighbour<GoTetrahedronElementBase<float>,float> (this_,face);
  }
  
  // Parents and children objects
  virtual GoGeometryElement<float> *getChild(int i) const {
    return NULL; //::getChild<GoTetrahedronElementBase<float>,float> (this_,i);
  }
  virtual void setChild(int i, GoGeometryElement<float> *face) {
    //::setChild<GoTetrahedronElementBase<float>,float> (this_,i,face);
  }
  ...
  virtual void statistic() const {
    ::statistic<GoTetrahedronElementBase<float>,float> (this_);
  }
  virtual void shrink() {
    ::shrink<GoTetrahedronElementBase<float>,float> (this_);
  }
...
private:
  GoTetrahedronElementBase<float> *this_;
};

//const int GoTetrahedronElement::numVerticesOfFace[4] =  {3,3,3,3};
