...
parser.add_argument('--type', help="predefined mesh type", choices=['bulk2d', 'bulk3d', 'cantilever2d', 'cantilever2d_reinforced', 'cantilever3d', 'lbm2d', 'lbm3d','msfem_two_load','two_load', 'validation_test','force_inverter','force_inverter_half','gripper','gripper_half','voxels_from_optistruct','convert_optistruct','traegerblz','box_lufo'], required = True)
