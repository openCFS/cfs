...
def read_stiff_angle(hdf_file, dim_2D, args):
  ...
  if args.parametrization == 'hom_rect':
    ...
    sh1 = get_element(f, "design_shear1_" + args.hom_access, args.h5_region, args.h5_step) if (args.show == "hom_sheared_cross" or args.show == "hom_sheared_rot_cross" or args.show == "hom_cross_bar") else sh1 
    ...
    if args.show == "hom_rect" or args.show == "hom_rot_cross" or args.show == "hom_sheared_cross" or args.show == "hom_sheared_rot_cross" or args.show == "hom_cross_bar" or args.show == "rot" or args.show == 'stream' or args.show == 'hom_rect_mod':
      ...
      if dim_2D:
        if args.show == "hom_rect": 
          ...
          viz = show_sheared_rot_cross(coords, s1, s2, sh1, angle, args.hom_dir, args.res, args.scale, args.color, args.save)
...
parser.add_argument("--show", help="mode within boebbale, hom_rect or streamline", choices=['ortho_norm', 'mono_norm', 'ortho_err', 'hom_rect', 'hom_rot_cross', 'hom_sheared_cross', 'hom_sheared_rot_cross', 'hom_cross_bar', 'rot', 'stream', 'hom_rect_mod']) 
