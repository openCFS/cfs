...
def perform(args, h5_read, dim_2D, tensor, centers, aux_code, force_scale=None):
  ...
  if h5_read or dim_2D:
    ...
    viz = None
    if args.show == "hom_rect" or args.show == "hom_rot_cross" or args.show == "hom_sheared_rot_cross" or args.show == "hom_cross_bar" or args.show == "rot" or args.show == 'stream' or args.show == 'hom_rect_mod':
...
parser.add_argument("--show", help="mode within boebbale, hom_rect or streamline", choices=['ortho_norm', 'mono_norm', 'ortho_err', 'hom_rect', 'hom_rot_cross', 'hom_sheared_rot_cross', 'hom_cross_bar', 'rot', 'stream', 'hom_rect_mod']) 
