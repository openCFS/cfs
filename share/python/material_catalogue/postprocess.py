...
for i in range(len(mat)):
    if mat[i][0] == '10' or mat[i][1] == '10' or mat[i][2] == '10':
        mat[i][3:len(mat[0])] = ['1.430976e+00', '6.734007e-01+00', '6.734007e-01', '1.430976e+00', '6.734007e-01','1.430976e+00', '3.787879e-01', '3.787879e-01', '3.787879e-01']

for i in range(len(vol)):
    if vol[i][0] == '10' or vol[i][1] == '10' or vol[i][2] == '10':
        vol[i][3] = '1.'        
output = open('detailed_stats_ortho_fcrc_bracket.txt', 'w')
for i in range(len(mat)):
