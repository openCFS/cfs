...
parser.add_argument("shape", help="choose between frame or cross or frame with smooth corners",choices=['frame', 'cross','frame_modified','frame_w_triangles', 'auxetic'])
