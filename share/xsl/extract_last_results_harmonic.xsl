...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <!-- This stylesheet extracts the results within info.xml from the first sequence step.
    We assume the harmonic case with complex results and give the result for the last frequency -->
...
<xsl:text>
    ...
    <xsl:value-of select="/cfsInfo/analysis/harmonic/process/solveStep[last()]/@currentFrequency"/><xsl:text> </xsl:text>
