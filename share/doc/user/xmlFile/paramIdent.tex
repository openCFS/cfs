...
@PYaZ[<analysis]@PYaZ[>]
  @PYaZ[<paramIdent]@PYaZ[>]
    @PYaZ[<fittingMethod] @PYaQ[type=]@PYaB["method"]@PYaZ[/>]
    @PYaZ[<fittingQuantity] @PYaQ[type=]@PYaB["physical_quantity"]@PYaZ[/>]
    @PYaZ[<calcImpedanceCurve]@PYaZ[>] yes/no @PYaZ[</calcImpedanceCurve>]
    @PYaZ[<calcCharge] @PYaQ[name=]@PYaB["surf"] @PYaQ[neighborRegion=]@PYaB["piezo_axi"]@PYaZ[/>]
    @PYaZ[<calcMechDisplacementCurve]@PYaZ[>] yes/no @PYaZ[</calcMechDisplacementCurve>]
    @PYaZ[<computeCurveAfterIterationStep]@PYaZ[>] positive_integer
@PYaZ[</computeCurveAfterIterationStep>]
    @PYaZ[<numFreq]@PYaZ[>] positive_integer @PYaZ[</numFreq>]
    @PYaZ[<startFreq]@PYaZ[>] positive_integer @PYaZ[</startFreq>]
    @PYaZ[<stopFreq]@PYaZ[>] positive_integer @PYaZ[</stopFreq>]
    @PYaZ[<maxNrIterations]@PYaZ[>] positive_integer @PYaZ[</maxNrIterations>]
    @PYaZ[<stopRes]@PYaZ[>] positive_integer @PYaZ[</stopRes>]
    @PYaZ[<excitationVoltage]@PYaZ[>] positive_integer @PYaZ[</excitationVoltage>]
    @PYaZ[<artDataNoise]@PYaZ[>] positive_integer @PYaZ[</artDataNoise>]
    @PYaZ[<mechDisplAtOppositeNode1]@PYaZ[>] positive_integer @PYaZ[</mechDisplAtOppositeNode1>]
    @PYaZ[<dofOfMechDispl1]@PYaZ[>] positive_integer @PYaZ[</dofOfMechDispl1>]
  @PYaZ[</paramIdent>]
@PYaZ[</analysis>]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=@\[\]]
  @PYaZ[<calcImpedanceCurve]@PYaZ[>] yes @PYaZ[</calcImpedanceCurve>]
  @PYaZ[<calcMechDisplacemetCurve]@PYaZ[>] yes@PYaZ[</calcMechDisplacementCurve>]
\end{Verbatim}
...
freedom (dof).\\
 E.g.  \\ 
\begin{Verbatim}[commandchars=@\[\]]
  @PYaZ[<mechDisplAtNode0]@PYaZ[>] 5 @PYaZ[</mechDisplAtNode0>]
  @PYaZ[<mechDisplAtOppositeNode0]@PYaZ[>] 15 @PYaZ[</mechDisplAtOppositeNode0>]
  @PYaZ[<dofOfMechDispl0]@PYaZ[>] 0 @PYaZ[</dofOfMechDispl0>]
\end{Verbatim}
...
@PYaZ[<domain] @PYaQ[geometryType=]@PYaB["axi"]@PYaZ[>]
  @PYaZ[<regionList]@PYaZ[>]
    @PYaZ[<region] @PYaQ[name=]@PYaB["piezo_axi"] @PYaQ[material=]@PYaB["PZ27"]@PYaZ[/>]
    @PYaZ[<region] @PYaQ[name=]@PYaB["adaption"] @PYaQ[material=]@PYaB["material1"]@PYaZ[/>]
    @PYaZ[<region] @PYaQ[name=]@PYaB["backing"] @PYaQ[material=]@PYaB["material2"]@PYaZ[/>]
  @PYaZ[</regionList>]
@PYaZ[</domain>]
\end{Verbatim}
