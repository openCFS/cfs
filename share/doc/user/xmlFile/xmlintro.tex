...
\begin{Verbatim}[commandchars=@\[\]]
  @PYaZ[<node_name]@PYaZ[>]ground@PYaZ[</node_name>]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<nodelist]@PYaZ[>]
  @PYaZ[<node1]@PYaZ[>]....@PYaZ[</node1>]
  @PYaZ[<node2]@PYaZ[>]....@PYaZ[</node2>]
@PYaZ[</nodelist>]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=@\[\]]
   @PYaZ[<problem] @PYaQ[name=]@PYaB["demo3d"]@PYaZ[>]@PYaZ[</problem>]
\end{Verbatim}

then the opening and the closing tag can, for brevity, be combined into one:
\begin{Verbatim}[commandchars=@\[\]]
   @PYaZ[<problem] @PYaQ[name=]@PYaB["demo3d"]@PYaZ[/>]
\end{Verbatim}
