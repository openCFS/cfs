...
The \texttt{input} function is currently available only for
\xel{dirichletInhom} and \xel{neumannInhom} boundary conditions, but may be
supported for other BCs in the future.
