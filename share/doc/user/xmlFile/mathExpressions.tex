...
%
\begin{mathFunc}
{input(fileid, sequencestep)}
\param{fileid} & Id of the \xel{hdf5}-input reader.\\
\param{sequencestep} & Multisequencestep to be used for reading in the values.
\end{mathFunc}
%
The \texttt{input} function is currently available only for inhomogeneous
Dirichlet boundary conditions, but may be supported for other BCs in the
future.
