...
\begin{Verbatim}[commandchars=@\[\]]
  @PYaZ[<constraint] @PYaQ[name=]@PYaB["homogenizationTensor"] @PYaQ[type=]@PYaB["equal"] @PYaQ[value=]@PYaB["-0.025 ]
@PYaB[coord="]@PYaI[1]@PYaI[2]@PYaI["]@PYaZ[/>]
\end{Verbatim}
...
@PYaZ[<constraint] @PYaQ[name=]@PYaB["homogenizationTensor"] @PYaQ[type=]@PYaB["equal"] @PYaQ[coord=]@PYaB["all"] @PYaZ[>]
  @PYaZ[<tensor] @PYaQ[dim1=]@PYaB["3"] @PYaQ[dim2=]@PYaB["3"]@PYaZ[>]
    @PYaZ[<real]@PYaZ[>]
      0.05    -0.025  0.0
     -0.025  0.05    0.0
      0.0     0.0    0.01
...
element.
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<constraint] @PYaQ[name=]@PYaB["homogenizationTracking"] @PYaQ[type=]@PYaB["equal"] @PYaQ[coord=]@PYaB["all"]@PYaZ[>]
  @PYaZ[<tensor] @PYaQ[dim1=]@PYaB["3"] @PYaQ[dim2=]@PYaB["3"]@PYaZ[>]
    @PYaZ[<real]@PYaZ[>]
      0.05    -0.025  0.0
     -0.025  0.05    0.0
