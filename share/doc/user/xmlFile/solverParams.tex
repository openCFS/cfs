...
\begin{Verbatim}[commandchars=@\[\]]
  @PYaZ[<linearSystems]@PYaZ[>]
    @PYaZ[<system] @PYaQ[name=]@PYaB["..."]@PYaZ[>]
      @PYaZ[<setup] @PYaI[.]@PYaI[.]@PYaI[.]@PYaZ[/>]
      @PYaZ[<matrix] @PYaI[.]@PYaI[.]@PYaI[.]@PYaZ[/>]
      @PYaZ[<exportLinSys] @PYaQ[baseName=]@PYaB["..."]@PYaZ[/>]
      @PYaZ[<solver] @PYaQ[type=]@PYaB["..."] @PYaQ[precond=]@PYaB["..."] @PYaZ[/>]
    @PYaZ[</system>]
  @PYaZ[</linearSystems>]
\end{Verbatim}

For each linear system for which properties are to be specified a separate
\xel{system} block must be inserted. The \xat{name} attribute is used to
...
@PYaZ[<sequenceStep]@PYaZ[>]
 ...
 @PYaZ[<linearSystems]@PYaZ[>]
   @PYaZ[<system] @PYaQ[name=]@PYaB["direct"]@PYaZ[>]
      @PYaZ[<exportLinSys] @PYaQ[baseName=]@PYaB["piezo"]@PYaZ[/>]
      @PYaZ[<solver] @PYaQ[type=]@PYaB["pardiso"]@PYaZ[/>]
   @PYaZ[</system>]
 @PYaZ[</linearSystems>]
 ...
@PYaZ[</sequenceStep>]
...
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<exportLinSys] @PYaQ[baseName=]@PYaB["piezo"] @PYaQ[format=]@PYaB["harwell-boeing"]@PYaZ[/>]
\end{Verbatim}

\item Compared to the example above, the solution vector is written to
'piezo.sol.vec'
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<exportLinSys] @PYaQ[baseName=]@PYaB["piezo"] @PYaQ[solution=]@PYaB["yes"] @PYaQ[format=]@PYaB["harwell-boeing"]@PYaZ[/>]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<exportLinSys] @PYaQ[baseName=]@PYaB["piezo"] @PYaQ[solution=]@PYaB["exclusive"] @PYaQ[format=]@PYaB["matrix-market"]@PYaZ[/>]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<stoppingRule] @PYaQ[type=]@PYaB["value"]@PYaZ[/>]
\end{Verbatim}
...
@PYaZ[<cfsSimulation] @PYaQ[xmlns=]@PYaB["http://www.cfs++.org"]@PYaZ[>]
 ...
 ...
  @PYaZ[<pdeList]@PYaZ[>]
    @PYaZ[<mechanic] @PYaI[.]@PYaI[.]@PYaI[.]@PYaZ[>]
        ...
    @PYaZ[</mechanic>]
  @PYaZ[</pdeList>]
  
  @PYaZ[<linearSystems]@PYaZ[>]
    @PYaZ[<system] @PYaQ[name=]@PYaB["mechanic"]@PYaZ[>]
       @PYaZ[<solver] @PYaQ[type=]@PYaB["ilupack"]@PYaZ[/>]
    @PYaZ[</system>]
  @PYaZ[</linearSystems>]
 @PYaZ[</sequenceStep>]
@PYaZ[</cfsSimulation>]
...
@PYaZ[<linearSystems]@PYaZ[>]
  @PYaZ[<system] @PYaQ[name=]@PYaB["mechanic"]@PYaZ[>]
     @PYaZ[<solver] @PYaQ[type=]@PYaB["ilupack"]@PYaZ[>]
        @PYaZ[<ilupack] @PYaQ[matrix=]@PYaB["pd"]@PYaZ[/>]
     @PYaZ[</solver>]
  @PYaZ[</system>]
@PYaZ[</linearSystems>]
\end{Verbatim}
...
@PYaZ[<solver] @PYaQ[type=]@PYaB["ilupack"]@PYaZ[>]
   @PYaZ[<ilupack]@PYaZ[>]
      @PYaZ[<iterativeSolver] @PYaQ[residualTol=]@PYaB["1.0E-8"]@PYaZ[/>]
   @PYaZ[</ilupack>]
@PYaZ[</solver>]
\end{Verbatim}
...
@PYaZ[<solver] @PYaQ[type=]@PYaB["ilupack"]@PYaZ[>]
   @PYaZ[<ilupack] @PYaQ[matrix=]@PYaB["pd"]@PYaZ[>]
      @PYaZ[<elbowSpace]@PYaZ[>]10@PYaZ[</elbowSpace>]
   @PYaZ[</ilupack>]
@PYaZ[</solver>]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<solver] @PYaQ[type=]@PYaB["ilupack"]@PYaZ[>]
  @PYaE[<!--]@PYaE[ this is a (symmetric) positive definit system ]@PYaE[-->]
  @PYaZ[<ilupack] @PYaQ[matrix=]@PYaB["pd"]@PYaZ[/>]
@PYaZ[</solver>]
\end{Verbatim}
...
@PYaZ[<solver] @PYaQ[type=]@PYaB["ilupack"]@PYaZ[>]
  @PYaZ[<ilupack] @PYaQ[matrix=]@PYaB["pd"]@PYaZ[>]
     @PYaZ[<permutation] @PYaQ[type=]@PYaB["initial"] @PYaQ[matrix=]@PYaB["gnl"] @PYaQ[ordering=]@PYaB["amd"] @PYaQ[matching=]@PYaB["none"]@PYaZ[/>]
     @PYaZ[<permutation] @PYaQ[type=]@PYaB["regular"] @PYaQ[matrix=]@PYaB["gnl"] @PYaQ[ordering=]@PYaB["amd"] @PYaZ[/>]
     @PYaZ[<permutation] @PYaQ[type=]@PYaB["final"]   @PYaQ[matrix=]@PYaB["pd"]  @PYaQ[ordering=]@PYaB["pp"] @PYaZ[/>] 
  @PYaZ[</ilupack>] 
@PYaZ[</solver>]
\end{Verbatim}
...
to
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<permutation] @PYaQ[type=]@PYaB["initial"] @PYaQ[matrix=]@PYaB["sym"] @PYaQ[ordering=]@PYaB["amd"] @PYaQ[matching=]@PYaB["mwm"]@PYaZ[/>]
\end{Verbatim}
...
@PYaZ[<solver] @PYaQ[type=]@PYaB["ilupack"]@PYaZ[>]
  @PYaZ[<ilupack] @PYaQ[matrix=]@PYaB["pd"]@PYaZ[>]
    @PYaZ[<engine] @PYaQ[type=]@PYaB["pcg"]@PYaZ[/>]
    @PYaZ[<dropTolLU]@PYaZ[>]1e-5@PYaZ[</dropTolLU>]
    @PYaZ[<iterativeSolver] @PYaQ[residualTol=]@PYaB["1.0E-8"]@PYaZ[/>]
    @PYaZ[<elbowSpace]@PYaZ[>]2@PYaZ[</elbowSpace>]
    @PYaZ[<condest]@PYaZ[>]5@PYaI[<]/condest
    @PYaZ[<maxIter]@PYaZ[>]2000@PYaZ[</maxIter>]
    @PYaZ[<flag] @PYaQ[name=]@PYaB["SimpleSC"] @PYaQ[state=]@PYaB["off"]@PYaZ[/>]
  @PYaZ[</ilupack>] 
@PYaZ[</solver>]
\end{Verbatim}
...
@PYaZ[<linearSystems]@PYaZ[>]
  @PYaZ[<system] @PYaQ[name=]@PYaB["direct"]@PYaZ[>]
    @PYaZ[<exportLinSys] @PYaQ[baseName=]@PYaB["piezo"] @PYaQ[solution=]@PYaB["exclusive"]@PYaZ[/>]
    @PYaZ[<solver] @PYaQ[type=]@PYaB["pardiso"]@PYaZ[/>]
  @PYaZ[</system>]
@PYaZ[</linearSystems>]
\end{Verbatim}
...
@PYaZ[<linearSystems]@PYaZ[>]
  @PYaZ[<system] @PYaQ[name=]@PYaB["mechanic"]@PYaZ[>]
    @PYaZ[<solver] @PYaQ[type=]@PYaB["pardiso"]@PYaZ[>]
      @PYaZ[<pardiso]@PYaZ[>]
        @PYaZ[<posDef]@PYaZ[>]yes@PYaZ[</posDef>]
        @PYaZ[<logging]@PYaZ[>]yes@PYaZ[</logging>]
      @PYaZ[</pardiso>]
     @PYaZ[</solver>]
  @PYaZ[</system>]
@PYaZ[</linearSystems>]
...
\begin{Verbatim}[commandchars=@\[\]]
@PYaZ[<linearSystems]@PYaZ[>]
  @PYaZ[<system] @PYaQ[name=]@PYaB["fluidMech"]@PYaZ[>]
    @PYaZ[<setup] @PYaQ[idbcHandling=]@PYaB["penalty"]@PYaZ[/>]
    @PYaZ[<matrix] @PYaQ[storage=]@PYaB["sparseNonSym"]@PYaZ[/>]
    @PYaZ[<solver] @PYaQ[type=]@PYaB["gmres"] @PYaQ[precond=]@PYaB["ILU0"]@PYaZ[>]
      @PYaZ[<gmres]@PYaZ[>]
        @PYaZ[<tol]@PYaZ[>]1e-3@PYaZ[</tol>]
        @PYaZ[<maxIter]@PYaZ[>]1000@PYaZ[</maxIter>]
        @PYaZ[<logging]@PYaZ[>]yes@PYaZ[</logging>]
      @PYaZ[</gmres>]
    @PYaZ[</solver>]
  @PYaZ[</system>]
