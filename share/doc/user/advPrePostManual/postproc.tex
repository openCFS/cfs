...
\noindent The current GMV  version is located in \texttt{/home/shareAll/linux\_bin/bin}
...
II format in ParaView (cf. \ref{sec:pv_adv_io}).
...
to Exodus  II files  by doing File$\rightarrow$Save  Data$\rightarrow$Files of
Type$\rightarrow$Exodus II.  ParaView can also  save data to native  VTK multi
block files or XDMF2 files (cf. Fig. \ref{fig:pv_adv_io}).
...
also located in \texttt{/home/shareAll/linux\_bin/bin}.
...
located in \texttt{/home/shareAll/linux\_bin/bin} and its  location has to be included in the
