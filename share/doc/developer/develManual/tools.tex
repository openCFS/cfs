...
\begin{figure}[htb] 
  ...
  \subfloat[Export to ANSYS tab.]{
    ...
    \begin{overpic}[grid,tics=10,scale=1.4]{pics/icem_export_ans}
%      \put(10,20){\textcolor{red}{\bf Test}}
  ...
  \subfloat[Element type options.]{
    ...
    \begin{overpic}[grid,tics=10,scale=1.4]{pics/icem_export_ansys_opts}
...
\item Solution: Use meshdiff mode of cfstool to compute difference and analytical solution script from paraview to compute L2 norm.
\end{itemize}
