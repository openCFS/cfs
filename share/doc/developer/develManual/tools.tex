...
\begin{enumerate}
   \item{Erzeuge ein TCL-File example.bch (Endung bch wichtig) mit folgendem Inhalt: \input{gid_batch}}
...
\item{Folgendes Shellscript nach /etc/init.d/gidpasserver speichern: \input{gid_pw_server}}
