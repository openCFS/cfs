...
if EXIST %CFS_BIN_DIR%\%WINDOWS_ARCH_STR% goto WINARCH_CHECK_FINISHED

set WINDOWS_ARCH_STR=%WINDOWS_PLATFORM%_I386
if EXIST %CFS_BIN_DIR%\%WINDOWS_ARCH_STR% goto WINARCH_CHECK_FINISHED

set WINDOWS_ARCH_STR=MINGW_%WINDOWS_ARCH%
if EXIST %CFS_BIN_DIR%\%WINDOWS_ARCH_STR% goto WINARCH_CHECK_FINISHED

set WINDOWS_ARCH_STR=MINGW_I386

:WINARCH_CHECK_FINISHED
