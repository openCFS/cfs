...
if mode == 'ortho':
  ...
  write_multi_design_file(filename[:-9] + "-" + mode + ".dens.xml", des[:,0:4], "stiff1", "stiff2", "gmodul", "rotAngle")
elif mode == 'dxlaminates':
  write_multi_design_file(filename[:-9] + "-" + mode + ".dens.xml", des, "stiff1", "stiff2", "gmodul", "rotAngle", "density")
