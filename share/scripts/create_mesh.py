...
parser.add_argument('--type', help="predefined mesh type", choices=['bulk2d', 'bulk3d', 'cantilever2d', 'cantilever2d_reinforced', 'lbm', 'msfem_test', 'ghost','triangle_msfem'], required=True)
...
elif args.type == 'bulk2d' or args.type.startswith('cantilever2d') or args.type.startswith('mbb') or args.type == 'msfem_test' or args.type == 'ghost' or args.type == 'triangle_msfem':
