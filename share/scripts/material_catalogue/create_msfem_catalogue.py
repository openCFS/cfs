...
if args.big:
    execute("./evaluate.py "+str(stp)+' '+str(dim)+' '+str(res)+' '+str(folder)+ ' --msfem ' + str(msfem)+' --mesh '+str(mesh)+' --big '+str(args.big))
else:
  os.chdir(str(pwd)+'/'+str(folder))
  execute("bash jobs")
  os.chdir(str(pwd))
  if args.design:
    execute("./evaluate.py "+str(stp)+' '+str(dim)+' '+str(res)+' '+str(folder)+ ' --msfem ' + str(msfem)+ ' --design '+str(args.design))
  else:
    execute("./evaluate.py "+str(stp)+' '+str(dim)+' '+str(res)+' '+str(folder)+ ' --msfem ' + str(msfem))
