...
namespace CoupledField
{
   ...
   * 'obj_scaling_factor' and 'nlp_scaling_method' with the value 'user-scaling'.
   * </p>
   *  */
  class SCPIPBase
  {
    public:
       ...
       * is called avert SolveProblem() prior to the eval_*() methods. */ 
      virtual bool get_scaling_parameters(double& obj_scaling, bool& use_g_scaling, int m, double* g_scaling)
      {
        throw "get_scaling_parameters() is called because of 'nlp_scaling_method' but not implemented";
      }
      ...
      typedef enum { Solve_Succeeded = 0, Maximum_Iterations_Exceeded = 1,
                     Subproblem_Max_Iter = 31, User_Requested_Stop = 1024} StateCode; 
