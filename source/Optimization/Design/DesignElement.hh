...
public:
  ...
  typedef enum { DESIGN, COST_GRADIENT, CONSTRAINT_GRADIENT, WEIGHT, OBJECTIVE, NUM_NEIGHBOURS,
    ...
    typedef enum { UNITY = -11, NO_DERIVATIVE = -10, NO_MULTIMATERIAL = -9,
                   ...
                   ROTANGLE, SHEAR1, STIFF1, STIFF2, STIFF3, LOWER_EIG_BOUND, ROTANGLEFIRST, ROTANGLESECOND, ROTANGLETHIRD, MULTIMATERIAL,INTERPOLATION,
                   NODE, PROFILE, RHS_DENSITY, // for mag opt, e.g. coil modelling (scaling current)
                   ALL_DESIGNS } Type;
