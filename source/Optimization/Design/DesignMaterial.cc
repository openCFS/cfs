...
//    t[0][0] = a*260.910 +ma*258.86;
//    t[0][1] = a*122.880 +ma*124.47;
//    t[0][2] = a*147.040 +ma*147.75;
//    t[0][3] = a*-0.0011639 +ma*0.00021276;
//    t[0][4] = a*0.0015323 +ma*0.00020339;
//    t[0][5] = a*-0.14353 +ma*0.095212;
//    t[1][0] = t[0][1];
//    t[1][1] = a*260.910 +ma*258.84;
//    t[1][2] = a*147.040 +ma*147.76;
//    t[1][3] = a*0.040643 +ma*0.038908;
//    t[1][4] = a*0.000039308 +ma*0.00011416;
//    t[1][5] = a*0.18457 +ma*-0.12128;
//    t[2][0] = t[0][2];
//    t[2][1] = t[1][2];
//    t[2][2] = a*236.720 +ma*235.55;
//    t[2][3] = a*0.00024251 +ma*-0.10246;
//    t[2][4] = a*-0.00068456 +ma*-0.00046745;
//    t[2][5] = a*-0.010199 +ma*-4.2832e-05;
//    t[3][0] = t[0][3];
//    t[3][1] = t[1][3];
//    t[3][2] = t[2][3];
//    t[3][3] = a*105.770 +ma*107.1;
//    t[3][4] = a*-0.052229 +ma*-0.000037784;
//    t[3][5] = a*0.1147 +ma*0.02109;
//    t[4][0] = t[0][4];
//    t[4][1] = t[1][4];
//    t[4][2] = t[2][4];
//    t[4][3] = t[3][4];
//    t[4][4] = a*105.840 +ma*107.26;
//    t[4][5] = a*-0.00092836 +ma*0.00025823;
//    t[5][0] = t[0][5];
//    t[5][1] = t[1][5];
//    t[5][2] = t[2][5];
//    t[5][3] = t[3][5];
//    t[5][4] = t[4][5];
//    t[5][5] = a*68.952 +ma*66.685;
    t[0][0] = a*260.910 +ma*258.86;
    t[0][1] = a*122.880 +ma*124.47;
    t[0][2] = a*147.040 +ma*147.75;
    t[0][3] = a*-0.0011639 +ma*0.00021276;
