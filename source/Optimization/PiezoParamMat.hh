...
private:
  ...
  virtual void SetElementK(DesignElement* de, const TransferFunction* tf, App::Type app, DenseMatrix* mat_out, bool derivative = true, CalcMode calcMode = STANDARD, double ev = -1.0);
