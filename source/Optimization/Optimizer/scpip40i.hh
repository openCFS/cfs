...
extern "C" 
{
  ...
  void scpip40i_(const int* n,            // ON INPUT (INTEGER = I): NUMBER OF VARIABLES, AT LEAST >=1. NOT ALTERED (NA)
			   ...
			   int* setact,
			   const int* ipopt_nargs,        // ON INPUT (I): Number of parameters passed to IPOPT23
         double* ipopt_args,            // ON INPUT (I): Values passed to IPOPT23
         char    ipopt_cargs[200]);     // ON INPUT (I): names of parameters passed to IPOPT23
