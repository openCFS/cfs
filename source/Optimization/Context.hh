...
=======
  ...
  typedef enum { MECH, ELEC, PIEZO_COUPLING, PRESSURE, CHARGE_DENSITY, MASS, HEAT, ACOUSTIC, ACOUSTIC_BEM, LAPLACE, STRESS, LBM, MAG, BUCKLING, NO_APP} Type;
>>>>>>> 61c131f75 (First steps in the direction of an AcousticPDE_BEM)
};
