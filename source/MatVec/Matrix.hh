...
//                    Double alpha, Double beta, bool transposed) const;
     ...
     * <name dim1="6" dim2="6">
      ...
      @param typeTag if false the inner <real>/<complex> wrapper is omitted 
      @param extra_attr optional extra attributes written into the opening tag, e.g. 'f="0" g="1"' */
    std::string ToXMLFormat(const std::string& name, const int n_offset,
                            bool typeTag = true, const std::string& extra_attr = "") const override;
