...
const int quaVertexOfFace[4] = {0,1,2,3};
...
const int quaEdgeOfFace[4] = {0,1,2,3};
...
//
// _____________________________________________________________________
const int quaAnisotropicEdgesToRefine[2][2] = {{1,3},{0,2}};
const int quaAnisotropicEdgesNoRefine[2][2] = {{0,2},{1,3}};
const int quaAnisotropicEdgesNoRefinePosition[2][2] = {{0,3},{2,5}};
const int quaAnisotropicRefinedEdgePosition[2][2][2] = {{{1,2},{4,5}},
                                                        {{0,1},{3,4}}};

const int quaAnisotropicVertexOfQuaChild[2][4][4] = {{{0,1,4,5},{5,4,2,3}},
                                                     {{0,4,5,3},{4,1,2,5}}};

const int quaAnisotropicEdgeOfQuaChild[2][4][4] = {{{0,1,6,5},{6,2,3,4}},
                                                   {{0,6,4,5},{1,2,3,6}}};
