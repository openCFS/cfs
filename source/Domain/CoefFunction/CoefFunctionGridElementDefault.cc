...
// ================================================================================================
/*!
 *       \file     CoefFunctionGridElementDefault.cc
...
CoefFunctionGridElementDefault<DATA_TYPE>::CoefFunctionGridElementDefault(Domain* ptDomain,
                                                                      PtrParamNode configNode,PtrParamNode curInfo,
                                                                      shared_ptr<RegionList> regions)
                                        :CoefFunctionGridElement<DATA_TYPE>(ptDomain, configNode, regions){
  //====================================================
...
// ========================
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::GetTensor(Matrix<DATA_TYPE>& CoefMat,
                       const LocPointMapped& lpm ){
  EXCEPTION("TENSORIAL RESULTS NOT SUPPORTED FOR INTERPOLATION FROM EXTERNAL GRIDS");
}
//todo #2 die neue coeff function braucht zumindest die Methode getVector
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::GetVector(Vector<DATA_TYPE>& CoefMat,
                       const LocPointMapped& lpm ){
...
//Todo #4 just extract the element solution
...
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::GetScalar(DATA_TYPE& CoefMat,
                       const LocPointMapped& lpm ){
...
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::SetRegions(shared_ptr<RegionList> regions){
...
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::GetScalarValuesAtPoints( const StdVector<Vector<Double> >  & points,
...
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::GetVectorValuesAtPoints( const StdVector<Vector<Double> >  & points,
...
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::GetTensorValuesAtPoints( const StdVector<Vector<Double> >  & points,
...
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::MapConservative( shared_ptr<FeSpace> targetSpace,
...
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::BuildNodeIdxAssoc(shared_ptr<FeSpace> targetSpace){
...
template<typename DATA_TYPE>
void CoefFunctionGridElementDefault<DATA_TYPE>::GetElemsForPoints(const StdVector<Vector<Double> >  & points,
                                                                  StdVector< const Elem* > & elements,
                                                                  StdVector<LocPoint> & locals){
  ...
  template class CoefFunctionGridElementDefault<Double>;
  template class CoefFunctionGridElementDefault<Complex>;
#endif
