...
// ================================================================================================
/*!
 *       \file     CoefFunctionGridElemDefault.cc 
...
CoefFunctionGridElemDefault<DATA_TYPE>::CoefFunctionGridElemDefault(Domain* ptDomain,
  ...
  if(type == ResultInfo::SCALAR){
    ...
    if ( this->dimDof_ == 4) {
      ...
      EXCEPTION("CoefFunctionGridElemDefault: Just tensor with 9 or 6 entries known");
  }
...
// ========================
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::GetTensor(Matrix<DATA_TYPE>& CoefMat,
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::GetVector(Vector<DATA_TYPE>& CoefMat,
                       const LocPointMapped& lpm ){
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::GetScalar(DATA_TYPE& CoefMat,
                       const LocPointMapped& lpm ){
  //no tensors right now
  assert(this->dimType_ != CoefFunction::TENSOR);
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::SetRegions(shared_ptr<RegionList> regions){
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::GetScalarValuesAtPoints( const StdVector<Vector<Double> >  & points,
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::GetVectorValuesAtPoints( const StdVector<Vector<Double> >  & points,
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::GetTensorValuesAtPoints( const StdVector<Vector<Double> >  & points,
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::MapConservative( shared_ptr<FeSpace> targetSpace,
                                                                 Vector<DATA_TYPE>& feFncVec){
  
  EXCEPTION("MapConservative is not implemented for CoefFunctionGridElemDefault");
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::BuildNodeIdxAssoc(shared_ptr<FeSpace> targetSpace){
  
  EXCEPTION("BuildNodeIdxAssoc is not implemented for CoefFunctionGridElemDefault");
...
template<typename DATA_TYPE>
void CoefFunctionGridElemDefault<DATA_TYPE>::GetElemsForPoints(const StdVector<Vector<Double> >  & points,
                                                                  StdVector< const Elem* > & elements,
                                                                  StdVector<LocPoint> & locals){
...
template class CoefFunctionGridElemDefault<Double>;
template class CoefFunctionGridElemDefault<Complex>;
