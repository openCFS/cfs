...
namespace CoupledField
{
  ...
  */
  ...
  public:
    ...
    /** @see Vector::Resize() */
    virtual bool Resize(const UInt size) = 0;
    ...
    */
    ...
    /** Sets the vector to zero. This is similar to Init() but there
     * are problems when using Init() w.o parameter */
    ...
    */
    ...
    virtual void Add(const Double a, const CFSVector* y) = 0;
