...
// ================================================================================================
/*!
 *       \file     CoefFunctionGridElemDefaultPrecice.hh
...
class CoefFunctionGridElemDefaultPrecice : public CoefFunctionGridElem<DATA_TYPE>{
public:

  CoefFunctionGridElemDefaultPrecice(Domain* ptDomain,
                                      PtrParamNode configNode,
                                      PtrParamNode curInfo,
                                      shared_ptr<RegionList> regions,
                                      ResultInfo::EntryType type);

  virtual ~CoefFunctionGridElemDefaultPrecice(){
  };

  virtual string GetName() const { return "CoefFunctionGridElemDefaultPrecice"; }
