...
namespace CoupledField
{
  ...
  public:
    ...
    */
    virtual void GetEdgeGlobalDerivShapeFnc(StdVector<Matrix<Double> > & deriv, 
                                            ...
                                            const Matrix<Double> & CornerCoords,
                                            const Elem* elem)
    { EXCEPTION("GetEdgeGlobDerivShFnc called for non edge element! ");};
    ...
    */
    virtual void CalcEdgeShapeFnc(Matrix<Double> & shape,
                                  ...
                                  const Matrix<Double> & CornerCoords,
                                  const Elem * elem)
    { EXCEPTION("CalcEdgeShapeFnc called for non edge element! ");};
  ...
  protected:
    ...
    { EXCEPTION("SetEdgeVertices called for non edge element! ");};
    ...
    */
    virtual void CalcLocalICModesDerivShapeFnc(Matrix<Double> & LDeriv,
					       ...
					       const Elem* elem, UInt dof,
					       AnsatzFct::FctEntityType = AnsatzFct::ALL ) {
      EXCEPTION("CalcLocalICModesDerivShapeFnc not implemented");
    };
