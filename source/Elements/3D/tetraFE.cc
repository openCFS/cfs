...
void TetraFE::FillIntegrationPoints()
{
   ...
   AddIntegrationPoints(ECONOMICAL, 4, 11, (Double*) a4);
   ...
   AddIntegrationPoints(ECONOMICAL, 6, 24, (Double*) a6);
   ...
   AddIntegrationPoints(ECONOMICAL, 7, 31, (Double*) a7);
   ...
   AddIntegrationPoints(ECONOMICAL, 8, 43, (Double*) a8);
