...
private:
  ...
  void d_collision_step_d_rho(unsigned int index, Matrix<double>& block, StdVector<double>& dfeqdux, StdVector<double>& dfeqduy, const StdVector<double>& ux, const StdVector<double>& uy, const StdVector<double>& dcol, const StdVector<double>& weight);

  void d_bounceback_d_rho(Matrix<double>& block);
