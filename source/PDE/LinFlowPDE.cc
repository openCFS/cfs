...
//           "dynamic viscosity: " << viscosity->ToString());
      ...
      if ( isCompressible_ ) {
    	  ...
    	  dampContextpp->SetFeFunctions( feFunctions_[FLUIDMECH_PRESSURE],
    			                         feFunctions_[FLUIDMECH_PRESSURE] );
...
//    }
  ...
  BaseBDBInt *
  LinFlowPDE::GetStiffIntegrator( BaseMaterial* actSDMat,
