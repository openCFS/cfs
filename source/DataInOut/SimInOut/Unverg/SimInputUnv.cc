...
namespace CoupledField {
                                       ...
                                       bool isHistory )
  {
    ...
    for ( UInt i=0; i<numRegions; ++i) {
      list.Push_back( mi_->GetEntityList(listType,
                                         regionNames_[i],
                                         EntityList::REGION));
    }
  }
...
//              int setIdx2 = datainfo_.Nsetinfo[i][(stepNum-1)/2+1].idx;
  ...
  Elem::FEType SimInputUnv::UnvType2ElemType( const UInt elemType ) {
    ...
    switch (elemType) {
      ...
      case 21:
      case 22:
        return Elem::LINE2; // line first oder
      case 23:
      case 24: 
        return Elem::LINE3; // line second oder
      case 41:
      case 51:
      case 61:
      case 71:
      case 81:
      case 91:
        return Elem::TRIA3; // triangle first oder
      case 42:
      case 52:
      case 62:
      case 72:
      case 82:
      case 92:
        return Elem::TRIA6; //triangle second order
      case 44:
      case 54:
      case 64:
      case 74:
      case 84:
      case 94:
        return Elem::QUAD4; //quadrilateral first order
      case 45:
      case 55:
      case 65:
      case 75:
      case 85:
      case 95:
        return Elem::QUAD8; //quadrilateral second order
      case 111:
        return Elem::TET4;  // tetrahedron first order
      case 118:
        return Elem::TET10;  // tetrahedron second order
      case 101:
      case 112:
        return Elem::WEDGE6;  // wedge first order
      case 102:
      case 113:
        return Elem::WEDGE15;  // wedge second order
      case 104:
      case 115:
        return Elem::HEXA8;  // brick first order
      case 105:
      case 116:
        return Elem::HEXA20;  // brick second order
    }
