...
namespace CoupledField {
  ...
  public:
    ...
    //! Starting CFS++ with the dump stats flags lets CFS++ print out
    ...
    //! Returns default value for --dumpStats parameter

    //! This method returns the default value for --dumpStats parameter.
    //! \return false
    bool DefaultDumpStats() const {
      return false;
    }

    //! Returns default value for --forceSegFaul parameter

    //! This method returns the default value for --forceSegFault parameter.
    //! \return false
    bool DefaultForceSegFault() const {
      return false;
    }
    ...
    //! Print information about CFS++ executable
