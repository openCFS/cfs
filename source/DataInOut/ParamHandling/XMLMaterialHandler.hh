...
namespace CoupledField {
  ...
  private:
    ...
    //! Reads <isotropic> section of mechanical material (real or imaginary part)
    ...
    void ReadHysteresis(BaseMaterial *material, PtrParamNode hystNode, bool setInversion);
  };
