      ...
      if (ai->Has("mpp")) {
        ...
        if (mpp->Has("porosity")) {
          PtrCoefFct porosityFct =
                    CoefFunction::Generate(mp_, Global::REAL,
                                           mpp->Get("porosity")->As<std::string>() );
