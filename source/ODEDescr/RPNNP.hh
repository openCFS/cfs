...
namespace CoupledField{
  ...
  //! Class to determine the bubble dynamics using the RPNNP-equations. 


  class RPNNP : public BubbleODE {
  ...
  //! 
  //! \purpose
  //! The equation is known as the  RPNNP model, it
