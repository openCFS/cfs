...
namespace CoupledField
{
  ...
  : BaseMaterial(mp, defaultCoosy) {
    ...
    isAllowed_.insert( PREISACH_WEIGHTS_MUDATEXT_A );
    isAllowed_.insert( PREISACH_WEIGHTS_MUDATEXT_H1 );
    isAllowed_.insert( PREISACH_WEIGHTS_MUDATEXT_H2 );
    isAllowed_.insert( PREISACH_WEIGHTS_MUDATEXT_SIGMA1 );
    isAllowed_.insert( PREISACH_WEIGHTS_MUDATEXT_SIGMA2 );
    isAllowed_.insert( PREISACH_WEIGHTS_MUDATEXT_ETA );
