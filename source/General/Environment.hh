...
namespace CoupledField {
  ...
  typedef enum { CATHODE, ANODE, DRAIN, SOURCE, GATE, BODY, COLLECTOR,
    ...
    typedef enum{NO_MATERIAL,MAGSTRICT_RELUCTIVITY, MAG_PERMEABILITY, MAG_RELUCTIVITY, MAG_RELUCTIVITY_DERIV, MAG_CONDUCTIVITY,
      ...
      PREISACH_WEIGHTS_TENSOR,PREISACH_WEIGHTS_FOR_MAYERGOYZ_VECTOR,PREISACH_MAYERGOYZ_NUM_DIR,PREISACH_MAYERGOYZ_ISOTROPIC,PREISACH_WEIGHTS_ANHYST_A,PREISACH_WEIGHTS_ANHYST_B,PREISACH_WEIGHTS_ANHYST_C, PREISACH_WEIGHTS_ANHYST_ONLY,     
