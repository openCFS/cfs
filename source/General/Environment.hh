...
namespace CoupledField {
  ...
  typedef enum { CATHODE, ANODE, DRAIN, SOURCE, GATE, BODY, COLLECTOR,
    ...
    typedef enum{
      ...
      // ===============
      ELEC_POTENTIAL, ELEC_FIELD_INTENSITY, ELEC_FIELD_INTENSITY_SURF, ELEC_FORCE_VWP,
    ...
    // ==========
	  ...
	  MAG_ENERGY, MAG_EDDY_POWER, MAG_EDDY_CURRENT, MAG_CORE_LOSS,
    ...
    typedef enum{NO_MATERIAL,MAGSTRICT_RELUCTIVITY, MAG_PERMEABILITY, MAG_RELUCTIVITY, MAG_RELUCTIVITY_DERIV, MAG_CONDUCTIVITY,
      ...
      A_JILES, ALPHA_JILES, K_JILES, C_JILES,
      X_SATURATION, Y_SATURATION, Y_REMANENCE,
      PREISACH_WEIGHTS,PREISACH_WEIGHTS_DIM,PREISACH_WEIGHTS_CONSTVALUE,PREISACH_WEIGHTS_TYPE,
      PREISACH_WEIGHTS_MUDAT_A,PREISACH_WEIGHTS_MUDAT_H,PREISACH_WEIGHTS_MUDAT_SIGMA,PREISACH_WEIGHTS_MUDAT_ETA,
      PREISACH_WEIGHTS_MUDATEXT_A,PREISACH_WEIGHTS_MUDATEXT_H1,PREISACH_WEIGHTS_MUDATEXT_H2,PREISACH_WEIGHTS_MUDATEXT_SIGMA1,
      PREISACH_WEIGHTS_MUDATEXT_SIGMA2,PREISACH_WEIGHTS_MUDATEXT_ETA,
      PREISACH_WEIGHTS_TENSOR,PREISACH_WEIGHTS_FOR_MAYERGOYZ_VECTOR,
      PREISACH_WEIGHTS_ANHYST_A,PREISACH_WEIGHTS_ANHYST_B,PREISACH_WEIGHTS_ANHYST_C, PREISACH_WEIGHTS_ANHYST_ONLY, 
      PREISACH_SCALEINITIALSTATE, PREISACH_PRESCRIBEOUTPUT, HYST_STRAIN_FORM,
      HYST_BETA_COEFS, DIM_BETA_COEFS, HYST_IRRSTRAINS, HYST_IRRSTRAIN_C1, HYST_IRRSTRAIN_C2, HYST_IRRSTRAIN_C3,
      P_DIRECTION, P_DIRECTION_X, P_DIRECTION_Y, P_DIRECTION_Z, 
      HYST_MODEL, PREISACH_DIM, 
      ROT_RESISTANCE, EVAL_VERSION,PRINT_PREISACH,PRINT_PREISACH_RESOLUTION,IS_TESTING, ANG_DISTANCE, ANG_CLIPPING, ANG_RESOLUTION, AMP_RESOLUTION, 
      ...
      X_SATURATION_STRAIN, Y_SATURATION_STRAIN, S_SATURATION,
      PREISACH_WEIGHTS_STRAIN,PREISACH_WEIGHTS_DIM_STRAIN,PREISACH_WEIGHTS_CONSTVALUE_STRAIN,PREISACH_WEIGHTS_TYPE_STRAIN,
      PREISACH_WEIGHTS_MUDAT_A_STRAIN,PREISACH_WEIGHTS_MUDAT_H_STRAIN,PREISACH_WEIGHTS_MUDAT_SIGMA_STRAIN,
      PREISACH_WEIGHTS_MUDAT_ETA_STRAIN,
      PREISACH_WEIGHTS_MUDATEXT_A_STRAIN,PREISACH_WEIGHTS_MUDATEXT_H1_STRAIN,PREISACH_WEIGHTS_MUDATEXT_H2_STRAIN,
      PREISACH_WEIGHTS_MUDATEXT_SIGMA1_STRAIN,PREISACH_WEIGHTS_MUDATEXT_SIGMA2_STRAIN,PREISACH_WEIGHTS_MUDATEXT_ETA_STRAIN,
      PREISACH_WEIGHTS_TENSOR_STRAIN,PREISACH_WEIGHTS_FOR_MAYERGOYZ_VECTOR_STRAIN,
      ...
      HYST_MODEL_STRAIN, PREISACH_DIM_STRAIN, 
      ...
      IRRSTRAIN_REUSE_P, HYST_COUPLING_DEFINED, 
