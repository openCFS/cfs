...
namespace CoupledField {
  ...
  typedef enum { CATHODE, ANODE, DRAIN, SOURCE, GATE, BODY, COLLECTOR,
    ...
    typedef enum{NO_MATERIAL,MAGSTRICT_RELUCTIVITY, MAG_PERMEABILITY, MAG_RELUCTIVITY, MAG_RELUCTIVITY_DERIV, MAG_CONDUCTIVITY,
      ...
      A_JILES, ALPHA_JILES, K_JILES, C_JILES, Y_REMANENCE,
      ...
      PREISACH_WEIGHTS_MUDAT_A_STRAIN,PREISACH_WEIGHTS_MUDAT_H_STRAIN,PREISACH_WEIGHTS_MUDAT_SIGMA_STRAIN,PREISACH_WEIGHTS_MUDAT_ETA_STRAIN,
      ...
      HYST_STRAIN_FORM, HYST_BETA_COEFS, DIM_BETA_COEFS, HYST_IRRSTRAINS, HYST_IRRSTRAIN_C1, HYST_IRRSTRAIN_C2, HYST_IRRSTRAIN_C3,
      // initial state
      ...
      HYST_INVERSION, STOP_INV_LS_AT_LOCAL_MIN, MAX_NUM_IT_HYST_INV, RES_TOL_H_HYST_INV, RES_TOL_B_HYST_INV, JAC_RESOLUTION_HYST_INV,   
