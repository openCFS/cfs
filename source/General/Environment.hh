...
namespace CoupledField {
  ...
  typedef enum { NO_NONLINEARITY, WESTERVELT, KUZNETSOV, VARIABLE_SOS_CN1,
    ...
    MATERIAL, GEOMETRIC, HYSTERESIS, HYSTERESIS_FIXPOINT, PIEZO_MICRO_HF, PERMEABILITY,
  ...
  typedef enum { CATHODE, ANODE, DRAIN, SOURCE, GATE, BODY, COLLECTOR,
    ...
    typedef enum{
      ...
      MECH_VISCO_STRESS,MECH_VISCO_STRAIN,
    ...
    typedef enum{NO_MATERIAL, MAG_PERMEABILITY, MAG_RELUCTIVITY, MAG_RELUCTIVITY_DERIV, MAG_CONDUCTIVITY,
      ...
      MECH_RELAXATION_TIMES,MECH_RELAXATION_TENSORS,MECH_VISCO_STIFFNESS_TENSOR,
      ...
      ALPHA_JILES, K_JILES, C_JILES, P_DIRECTION, HYST_MODEL, PREISACH_DIM, ROT_RESISTANCE,
    ...
    // describes the possible material models (as used by materialModelList)
    typedef enum{MECH_LINEAR_ELASTIC,MECH_LINEAR_VISCOELASTIC} MaterialModel;
    extern Enum<MaterialModel> MaterialModelEnum;
