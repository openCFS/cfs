...
namespace CoupledField {
  ...
  typedef enum { CATHODE, ANODE, DRAIN, SOURCE, GATE, BODY, COLLECTOR,
    ...
    typedef enum{NO_MATERIAL,MAGSTRICT_RELUCTIVITY, MAG_PERMEABILITY, MAG_RELUCTIVITY, MAG_RELUCTIVITY_DERIV, MAG_CONDUCTIVITY,
      ...
      X_SATURATION, Y_SATURATION, S_SATURATION, Y_REMANENCE, PREISACH_WEIGHTS,PREISACH_WEIGHTS_DIM,PREISACH_WEIGHTS_CONSTVALUE,PREISACH_WEIGHTS_TYPE,
      PREISACH_WEIGHTS_MUDAT_A,PREISACH_WEIGHTS_MUDAT_H,PREISACH_WEIGHTS_MUDAT_SIGMA,PREISACH_WEIGHTS_MUDAT_ETA,
      PREISACH_WEIGHTS_MUDATEXT_A,PREISACH_WEIGHTS_MUDATEXT_H1,PREISACH_WEIGHTS_MUDATEXT_H2,PREISACH_WEIGHTS_MUDATEXT_SIGMA1,PREISACH_WEIGHTS_MUDATEXT_SIGMA2,PREISACH_WEIGHTS_MUDATEXT_ETA,
      PREISACH_WEIGHTS_TENSOR,PREISACH_WEIGHTS_FOR_MAYERGOYZ_VECTOR,PREISACH_MAYERGOYZ_NUM_DIR,PREISACH_MAYERGOYZ_ISOTROPIC,PREISACH_MAYERGOYZ_CLIPOUTPUT,
      ...
      A_JILES, ALPHA_JILES, K_JILES, C_JILES, P_DIRECTION, P_DIRECTION_X, P_DIRECTION_Y, P_DIRECTION_Z, SCALPREISACH_USE_EXT, HYST_MODEL, PREISACH_DIM, ROT_RESISTANCE, EVAL_VERSION,
      PRINT_PREISACH,PRINT_PREISACH_RESOLUTION,IS_TESTING, ANG_DISTANCE, ANG_CLIPPING, ANG_RESOLUTION, 
      AMP_RESOLUTION, HYST_INVERSION, MAX_NUM_IT_HYST_INV, RES_TOL_H_HYST_INV, RES_TOL_B_HYST_INV, JAC_RESOLUTION_HYST_INV,   
      TIKHONOV_HYST_INV, ALPHA_LS_HYST_INV, ALPHA_LS_MIN_HYST_INV, ALPHA_LS_MAX_HYST_INV, INITIAL_STATE,
