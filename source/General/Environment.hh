...
namespace CoupledField {
  ...
  typedef enum{
    ...
    FLUID_BULK_VISCOSITY, FLUID_REF_PRESSURE,
    ...
    MAG_CONDUCTIVITY_TENSOR, MAG_CONDUCTIVITY_SCALAR,
  ...
  typedef enum{
    NO_CLASS, TESTMAT, ELECTROMAGNETIC, ELECTROSTATIC, ACOUSTIC, FLOW, MECHANIC,
  ...
  typedef enum {NOTYPE, SYSTEM = 1, STIFFNESS, DAMPING, CONVECTION, MASS, AUXILIARY, STIFFNESS_UPDATE, DAMPING_UPDATE , MASS_UPDATE,
    SYSTEM_HYSTFREE, SYSTEM_FIXPOINT, SYSTEM_FD_JACOBIAN, SYSTEM_DELTAMAT_JACOBIAN, SYSTEM_BAK, GEOMETRIC_STIFFNESS}
  FEMatrixType;
