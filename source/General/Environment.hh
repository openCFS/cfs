...
namespace CoupledField {
  ...
  typedef enum { CATHODE, ANODE, DRAIN, SOURCE, GATE, BODY, COLLECTOR,
    ...
    typedef enum{NO_MATERIAL,MAGSTRICT_RELUCTIVITY, MAG_PERMEABILITY, MAG_RELUCTIVITY, MAG_RELUCTIVITY_DERIV, MAG_CONDUCTIVITY,
      ...
      PREISACH_WEIGHTS_TENSOR,PREISACH_WEIGHTS_FOR_MAYERGOYZ_VECTOR,PREISACH_MAYERGOYZ_NUM_DIR,PREISACH_MAYERGOYZ_ISOTROPIC,PREISACH_MAYERGOYZ_CLIPOUTPUT,PREISACH_WEIGHTS_ANHYST_A,PREISACH_WEIGHTS_ANHYST_B,PREISACH_WEIGHTS_ANHYST_C, PREISACH_WEIGHTS_ANHYST_ONLY,     
      PREISACH_SCALEINITIALSTATE, PREISACH_PRESCRIBEOUTPUT, HYST_STRAIN_FORM, HYST_BETA_COEFS, DIM_BETA_COEFS, A_JILES,
      ALPHA_JILES, K_JILES, C_JILES, P_DIRECTION, P_DIRECTION_X, P_DIRECTION_Y, P_DIRECTION_Z, SCALPREISACH_USE_EXT, HYST_MODEL, PREISACH_DIM, ROT_RESISTANCE, EVAL_VERSION,
