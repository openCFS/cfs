...
namespace CoupledField {
  ...
  enum DampingType{NONE=0, RAYLEIGH=1, ABCDAMP=2, THERMOVISCOUS=3,
    ...
    ADAPTED_LOSS_TANGENS_DELTA = 12, GLOBAL_RAYLEIGH = 13, KELVIN_VOIGT = 14};
  ...
  typedef enum { NO_NONLINEARITY, WESTERVELT, KUZNETSOV, VARIABLE_SOS_CN1,
    ...
    MATERIAL, GEOMETRIC, STRAIN_STIFFENING, HYSTERESIS, PIEZO_MICRO_HF, PERMEABILITY, PERMEABILITY_FROZEN, RELUCTIVITY, RELUCTIVITY_MAGSTRICT,
  ...
  typedef enum{
    ...
    //  SMOOTH
    // =================
    SMOOTH_DISPLACEMENT, SMOOTH_VELOCITY, SMOOTH_ZERO_PRESSURE, SMOOTH_STRAIN, SMOOTH_STRESS,
    ...
    ACOU_ELEM_SPEED_OF_SOUND, ACOU_SURF_AVG_IMPEDANCE, ACOU_SURFIMPEDANCE,

    // Auxiliary variables for TDEF formulation (currently limited to 15 poles)
    ACOU_TDEF_PHI_C_1, ACOU_TDEF_PHI_C_2, ACOU_TDEF_PHI_C_3, ACOU_TDEF_PHI_C_4, ACOU_TDEF_PHI_C_5,
    ACOU_TDEF_PHI_C_6, ACOU_TDEF_PHI_C_7, ACOU_TDEF_PHI_C_8, ACOU_TDEF_PHI_C_9, ACOU_TDEF_PHI_C_10,
    ACOU_TDEF_PHI_C_11, ACOU_TDEF_PHI_C_12, ACOU_TDEF_PHI_C_13, ACOU_TDEF_PHI_C_14, ACOU_TDEF_PHI_C_15,

    ACOU_TDEF_PSI_C_1, ACOU_TDEF_PSI_C_2, ACOU_TDEF_PSI_C_3, ACOU_TDEF_PSI_C_4, ACOU_TDEF_PSI_C_5,
    ACOU_TDEF_PSI_C_6, ACOU_TDEF_PSI_C_7, ACOU_TDEF_PSI_C_8, ACOU_TDEF_PSI_C_9, ACOU_TDEF_PSI_C_10,
    ACOU_TDEF_PSI_C_11, ACOU_TDEF_PSI_C_12, ACOU_TDEF_PSI_C_13, ACOU_TDEF_PSI_C_14, ACOU_TDEF_PSI_C_15,

    ACOU_TDEF_PHI_V_1, ACOU_TDEF_PHI_V_2, ACOU_TDEF_PHI_V_3, ACOU_TDEF_PHI_V_4, ACOU_TDEF_PHI_V_5,
    ACOU_TDEF_PHI_V_6, ACOU_TDEF_PHI_V_7, ACOU_TDEF_PHI_V_8, ACOU_TDEF_PHI_V_9, ACOU_TDEF_PHI_V_10,
    ACOU_TDEF_PHI_V_11, ACOU_TDEF_PHI_V_12, ACOU_TDEF_PHI_V_13, ACOU_TDEF_PHI_V_14, ACOU_TDEF_PHI_V_15,

    ACOU_TDEF_PSI_V_1, ACOU_TDEF_PSI_V_2, ACOU_TDEF_PSI_V_3, ACOU_TDEF_PSI_V_4, ACOU_TDEF_PSI_V_5,
    ACOU_TDEF_PSI_V_6, ACOU_TDEF_PSI_V_7, ACOU_TDEF_PSI_V_8, ACOU_TDEF_PSI_V_9, ACOU_TDEF_PSI_V_10,
    ACOU_TDEF_PSI_V_11, ACOU_TDEF_PSI_V_12, ACOU_TDEF_PSI_V_13, ACOU_TDEF_PSI_V_14, ACOU_TDEF_PSI_V_15,
    ...
    // ==========
    // -- primary results --
    MAG_POTENTIAL, MAG_POTENTIAL_ADJ, MAG_POTENTIAL_DERIV1, MAG_POTENTIAL_ADJ_DERIV1, MAG_TOTAL_POTENTIAL, 
    MAG_REDUCED_POTENTIAL, MAG_RHS_LOAD, MAG_RHS_LOAD_ADJ, MAG_POTENTIAL_GRAD_ADJ,
    ...
    MAG_POTENTIAL_GRAD, MAG_CURL_ADJ, MAG_FIELD_INTENSITY_CURL, 

    MAG_FORCE_MAXWELL_DENSITY, MAG_NORMALFORCE_MAXWELL_DENSITY, MAG_TANGENTIALFORCE_MAXWELL_DENSITY,
    MAG_FORCE_MAXWELL_DENSITY_STATIC, MAG_FORCE_MAXWELL_DENSITY_HARMONIC,
    ...
    MAG_FORCE_MAXWELL_STATIC, MAG_FORCE_MAXWELL_HARMONIC,
    MAG_GRAD_ADJ_PARAM, MAG_GRAD_ADJ_PARAM1, MAG_GRAD_ADJ_PARAM2, MAG_GRAD_ADJ_PARAM3, MAG_GRAD_ADJ_PARAM4,
    MAG_ENERGY, MAG_EDDY_POWER, MAG_EDDY_CURRENT, MAG_EDDY_CURRENT1, MAG_EDDY_CURRENT2, MAG_TOTAL_CURRENT, MAG_CORE_LOSS,
    MAG_AVERAGED_FIELD_INTENSITY, MAG_AVERAGED_FLUX_DENSITY,
   
    // -- coil quantities --
    COIL_INDUCTANCE, COIL_INDUCED_VOLTAGE, COIL_CURRENT, COIL_VOLTAGE, COIL_VOLTAGE_INTEGRAL, COIL_LINKED_FLUX, COIL_CURRENT_DERIV1,
    ...
    FLUIDMECH_VOLUME_FLOW_RATE, FLUIDMECH_AVERAGED_PRESSURE,
    ...
    OPT_RESULT_13, OPT_RESULT_14, OPT_RESULT_15, OPT_RESULT_16,
    OPT_RESULT_BOUND, /** Indicates the last OPT_RESULT_*, extend before this marker which needs to be after the last OPT_RESULT_x */ 
  ...
  typedef enum{
    ...
    ACOU_TDEF_INVDENS_CONST,ACOU_TDEF_INVDENS_A,ACOU_TDEF_INVDENS_ALPHA,ACOU_TDEF_INVDENS_B,ACOU_TDEF_INVDENS_BETA,ACOU_TDEF_INVDENS_C,ACOU_TDEF_INVDENS_GAMMA,
    ACOU_TDEF_INVBLK_CONST,ACOU_TDEF_INVBLK_A,ACOU_TDEF_INVBLK_ALPHA,ACOU_TDEF_INVBLK_B,ACOU_TDEF_INVBLK_BETA,ACOU_TDEF_INVBLK_C,ACOU_TDEF_INVBLK_GAMMA,
    ...
    MAG_RELUCTIVITY_DERIV_P1, MAG_RELUCTIVITY_DERIV_P2, MAG_RELUCTIVITY_DERIV_P3, MAG_RELUCTIVITY_DERIV_P4,
    MAG_ANHYST_DERIV_P1, MAG_ANHYST_DERIV_P2, MAG_ANHYST_DERIV_P3, MAG_ANHYST_DERIV_P4,
    ...
    MAG_PS_EB, MAG_A_EB, MAG_MU0_EB, MAG_MSAT_PACEJKA_EB,MAG_A_PACEJKA_EB,MAG_B_PACEJKA_EB,MAG_C_PACEJKA_EB, MAG_JACOBIAN_METHOD_EB,
    MAG_APPROX_TYPE, MAG_MSM_AS, MAG_MSM_K1, MAG_MSM_K2, MAG_MSM_LAMBDA100, MAG_MSM_LAMBDA111, MAG_MSM_PS,MAG_ANHYST_TYPE_EB,
    MAG_ANHYST_FORMULA_EB,MAG_PINNING_FORCES_WEIGHTS_EB,MAG_WEIGHTS_FILE_PATH_EB,
    MAG_NUMS_EB, MAG_CHI_FACTOR_EB, //these two are the old implementation but they are still needed for the invEBHyst
    // -- Magnetic inverse EB Hysteresis Parameters
    MAG_JS_INVEB, MAG_MS_INVEB, MAG_A_INVEB, MAG_PA_INVEB, MAG_PB_INVEB, MAG_PC_INVEB, MAG_JACOBIAN_METHOD_INVEB,
    MAG_ANHYST_TYPE_INVEB, MAG_ANHYST_FORMULA_INVEB, MAG_P0_INVEB, MAG_P1_INVEB, MAG_P2_INVEB, MAG_PINNING_FORCES_WEIGHTS_INVEB, 
    MAG_WEIGHTS_FILE_PATH_INVEB, MAG_LOOKUP_TABLE_FILE_INVEB,
    // ============
    //  MECHANICAL
    // ============
