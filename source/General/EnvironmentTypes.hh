...
namespace CoupledField {
  ...
  typedef enum { NO_NONLINEARITY, WESTERVELT, KUZNETSOV, VARIABLE_SOS_CN1,
    ...
    MATERIAL, GEOMETRIC, HYSTERESIS, PIEZO_MICRO_HF, PERMEABILITY, PERMEABILITY_FROZEN, RELUCTIVITY_MAGSTRICT,
  ...
  typedef enum{
    ...
    //  ELECTRIC NETWORK
    // ===============
    ELEC_NETWORK_POTENTIAL, ELEC_NETWORK_RHS_LOAD, ELEC_NETWORK_AUX,
  ...
  typedef enum{
    ...
    ELEC_NETWORK_CONDUCTIVITY_TENSOR, ELEC_NETWORK_CONDUCTIVITY_SCALAR,
    ELEC_NETWORK_CONDUCTIVITY_1, ELEC_NETWORK_CONDUCTIVITY_2, ELEC_NETWORK_CONDUCTIVITY_3,
