...
namespace CoupledField {
  ...
  typedef enum{
    ...
    ELEC_CHARGE, ELEC_SURFACE_CHARGE_DENSITY, ELEC_FLUX_DENSITY, ELEC_RHS_LOAD, ELEC_RHS_LOAD_ADJ,
    ...
    SMOOTH_CONTACT_FORCE_DENSITY, SMOOTH_CONTACT_FORCE, SMOOTH_DEFORM_ENERGY_DENS,
