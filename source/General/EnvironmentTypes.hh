...
namespace CoupledField {
  ...
  typedef enum{
    ...
    MAG_RELUCTIVITY_TENSOR, MAG_RELUCTIVITY_SCALAR, MAG_RELUCTIVITY_DERIV, MAG_RELUCTIVITY_DERIV_P1,
    MAG_RELUCTIVITY_DERIV_P2, MAG_RELUCTIVITY_DERIV_P3, MAG_RELUCTIVITY_DERIV_P4,
