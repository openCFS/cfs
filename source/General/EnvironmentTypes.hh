...
namespace CoupledField {
  ...
  typedef enum{
    ...
    //  PSEUDO MECHANIC
    // =================
    SMOOTH_DISPLACEMENT, SMOOTH_VELOCITY, SMOOTH_ACCELERATION, SMOOTH_ZERO_PRESSURE, SMOOTH_STRAIN,
    SMOOTH_CONTACT_FORCE_DENSITY, SMOOTH_CONTACT_FORCE,
  ...
  typedef enum{
    ...
    ELECTRICCONDUCTION, ELECQUASISTATIC
  } MaterialClass;
