...
namespace CoupledField {
  ...
  typedef enum { NO_NONLINEARITY, WESTERVELT, KUZNETSOV, VARIABLE_SOS_CN1,
    ...
    MATERIAL, GEOMETRIC, STRAIN_STIFFENING, HYSTERESIS, PIEZO_MICRO_HF, PERMEABILITY, PERMEABILITY_FROZEN, RELUCTIVITY_MAGSTRICT,
  ...
  typedef enum{
    ...
    MECH_TOTAL_ENERGY_DENS, MECH_NORMAL_STRESS, MECH_NORMAL_STRESS_PRECICE, MECH_THERMAL_STRESS,
    ...
    ACOU_ELEM_SPEED_OF_SOUND, ACOU_SURF_AVG_IMPEDANCE, ACOU_SURFIMPEDANCE, ACOU_CHARACTERISTIC, ACOU_CHARACTERISTIC_COUPLING,
    ...
    FLUIDMECH_PRESSURE, FLUIDMECH_ZERO_PRESSURE, FLUIDMECH_ABSOLUTE_PRESSURE,
