...
namespace CoupledField {
  ...
  typedef enum{
    ...
    // ===============
    ELEC_POTENTIAL, ELEC_POTENTIAL_DERIV1, ELEC_FIELD_INTENSITY, ELEC_FIELD_INTENSITY_SURF, ELEC_FORCE_VWP, ELEC_FORCE_DENSITY, 
    ...
    FLUIDMECH_STRESS, FLUIDMECH_TOTAL_STRESS, FLUIDMECH_STRAINRATE, 
