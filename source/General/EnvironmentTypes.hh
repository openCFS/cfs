...
namespace CoupledField {
  ...
  typedef enum { NO_NONLINEARITY, WESTERVELT, KUZNETSOV, VARIABLE_SOS_CN1,
    ...
    MAT_RELUCTIVITY, MAT_PERMITTIVITY, MAT_CONDUCTIVITY} NonLinType;
  ...
  typedef enum{
    ...
    ELEC_FIELD_INTENSITY_ADJ, ELEC_FORCE, ELEC_FORCE_VWP, ELEC_FORCE_DENSITY,
    ELEC_CHARGE, ELEC_CHARGE_DENSITY, ELEC_FLUX_DENSITY, ELEC_RHS_LOAD, ELEC_RHS_LOAD_ADJ,
    ...
    ELEC_AND_DISPLACEMENT_CURRENT, ELEC_FIELD_VORTICITY, ELEC_FIELD_VORTICITY_ADJ,
    ...
    MAG_ELEM_PERMITTIVITY,MAG_ELEM_RELUCTIVITY_DERIV,MAG_ELEM_PERMITTIVITY_DERIV,
    ...
    ELEM_DENSITY,PML_DAMP_FACTOR, GRAD_PARAM1, GRAD_PARAM2, GRAD_PARAM3,
  ...
  typedef enum{
    ...
    //  ELECTROSTATIC
    // ===============
    ELEC_PERMITTIVITY_TENSOR, ELEC_PERMITTIVITY_SCALAR, ELEC_PERMITTIVITY_DERIV,
