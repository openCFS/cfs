...
namespace CoupledField {
  ...
  typedef enum{
    ...
    MAG_FORCE_VWP_DENSITY, MAG_FORCE_VWP_DENSITY_STATIC, MAG_EDDY_POWER_DENSITY, MAG_ENERGY_DENSITY, MAG_CORE_LOSS_DENSITY,
    MAG_JOULE_LOSS_POWER_DENSITY, MAG_JOULE_LOSS_POWER_DENSITY_ON_NODES, MAG_JOULE_LOSS_POWER,ELEC_POTENTIAL_DERIV_1,

    // -- integrated quantities --
    MAG_FORCE_VWP,  MAG_FORCE_VWP_STATIC, MAG_FORCE_LORENTZ, MAG_FORCE_MAXWELL,
