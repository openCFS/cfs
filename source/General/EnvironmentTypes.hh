...
namespace CoupledField {
  ...
  typedef enum { NO_NONLINEARITY, WESTERVELT, KUZNETSOV, VARIABLE_SOS_CN1,
    ...
    NLHEAT_CONDUCTIVITY, NLHEAT_CAPACITY, NLHEAT_DENSITY, THERMAL_RADIATION, NLELEC_CONDUCTIVITY, /* temperature dep */
  ...
  typedef enum{
    ...
    ELEC_FORCE, ELEC_FORCE_BALANCED, ELEC_FORCE_VWP, ELEC_FORCE_DENSITY, ELEC_FORCE_DENSITY_BALANCED,
    ...
    ELEC_CURRENT_DENSITY, ELEC_FIELD_INTENSITY_TRANSVERSAL, ELEC_FIELD_INTENSITY_LONGITUDINAL,
	  ELEC_GRAD_V_INT, ELEC_NORMAL_CURRENT_DENSITY, ELEC_CURRENT, ELEC_POWER, ELEC_POWER_DENSITY,
	  DISPLACEMENTCURRENT_FIELD_INTENSITY, DISPLACEMENTCURRENT_SURF,
    ...
    SMOOTH_CONTACT_FORCE_DENSITY, SMOOTH_CONTACT_FORCE, SMOOTH_CONTACT_FORCE_DENSITY_BALANCED,
    SMOOTH_CONTACT_FORCE_BALANCED,
