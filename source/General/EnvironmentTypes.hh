...
namespace CoupledField {
  ...
  typedef enum { NO_NONLINEARITY, WESTERVELT, KUZNETSOV, VARIABLE_SOS_CN1,
    ...
    MATERIAL, GEOMETRIC, HYSTERESIS, PIEZO_MICRO_HF, PERMEABILITY, RELUCTIVITY, RELUCTIVITY_MAGSTRICT,
    NLHEAT_CONDUCTIVITY, NLHEAT_CAPACITY, NLHEAT_DENSITY, NLHEAT_SOURCE, THERMAL_RADIATION, NLELEC_CONDUCTIVITY, /* temperature dep */
    NLELEC_BIPOLE, NLELEC_BIPOLE_TEMP_DEP, NLELEC_TRIPOLE, NLELEC_TRIPOLE_TEMP_DEP, NLELEC_PERMITTIVITY, 
    MAT_RELUCTIVITY, MAT_PERMEABILITY} NonLinType;
  ...
  typedef enum{
    ...
    // --- flux / derived quantities --
    MAG_FLUX_DENSITY, MAG_FLUX_DENSITY_ADJ, MAG_FLUX, MAG_FLUX_ADJ, MAG_NORMAL_FLUX_DENSITY, MAG_FLUX_DENSITY_SURF, MAG_FIELD_INTENSITY, MAG_EDDY_CURRENT_DENSITY,
    ...
    MAG_POTENTIAL_GRAD, MAG_CURL_ADJ, MAG_FIELD_INTENSITY_CURL, MAG_NORMAL_FLUX_DENSITY_ADJ,
    ...
    // -- integrated quantities --
    MAG_FORCE_VWP, MAG_FORCE_LORENTZ, MAG_FORCE_MAXWELL, MAG_GRAD_ADJ_PARAM,
    MAG_GRAD_ADJ_PARAM1, MAG_GRAD_ADJ_PARAM2, MAG_GRAD_ADJ_PARAM3, MAG_GRAD_ADJ_PARAM4,
    ...
    ELEM_DENSITY, GRAD_PARAM1, GRAD_PARAM2, GRAD_PARAM3, 
