...
namespace CoupledField {
  ...
  typedef enum{NO_SOLUTION_TYPE, MECH_DISPLACEMENT, MECH_ACCELERATION,
               ...
               MECH_ENERGY, MECH_DEF_VOLUME, MECH_RHS_LOAD, MECH_PSEUDO_DENSITY, MECH_SHAPE,
               ...
               ACOU_PRESSURE_DERIV_2,ACOU_VELOCITY,ACOU_ACCELERATION, ACOU_FORCE, ACOU_POT_NRBC,
  ...
  typedef enum{NO_MATERIAL, MAG_PERMEABILITY, MAG_RELUCTIVITY, MAG_CONDUCTIVITY,
               ...
               SCALE_FORCE_ELEC, SCALE_FORCE_MECH, SCALE_FORCE_COUPLE} MaterialType;
  ...
  static const UInt MAX_NUM_FE_MATRICES = 6;
...
#define DEFINE_ENUM_CONVERSION(TYPE)                                  \
  ...
  DEFINE_ENUM_CONVERSION(PrecondType)
  DEFINE_ENUM_CONVERSION(StopCritType)
  DEFINE_ENUM_CONVERSION(ReorderingType)
