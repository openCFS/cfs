...
namespace CoupledField {
  ...
  typedef enum{NO_SOLUTION_TYPE, MECH_DISPLACEMENT,
               LUMPED_MECH_DISPLACEMENT, MECH_ACCELERATION,
               MECH_VELOCITY, MECH_FORCE, MECH_STRESS, MECH_STRAIN, MECH_STRAIN_IRR, VON_MISES_STRESS, VON_MISES_STRAIN,
               ...
               ACOU_PRESSURE_DERIV_2,ACOU_VELOCITY,ACOU_ACCELERATION, ACOU_FORCE, ACOU_POT_NRBC, ACOU_PSEUDO_DENSITY,
               NRBC_PHI, ACOU_POWERDENSITY, ACOU_POWER, ACOU_INTENSITY, ACOU_ENERGY,
               ACOU_POTENTIAL_DERIV_1, ACOU_POTENTIAL_DERIV_2, ACOU_RHS_LOAD, ACOU_RHS_LOAD_DENSITY, ACOU_RHSVAL, ACOUSURF_RHSVAL,
