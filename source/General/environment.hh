...
namespace CoupledField {
  ...
  typedef enum { NO_NONLINEARITY, WESTERVELT, KUZNETSOV, VARIABLE_SOS_CN1,
   ...
   typedef enum{
    ...
    LBM_NODAL_PROBABILITY_DISTRIBUTION, LBM_PROBABILITY_DISTRIBUTION, LBM_VELOCITY, LBM_DENSITY, LBM_PRESSURE, LBM_PHYSICAL_PSEUDO_DENSITY,
    ...
    OPT_RESULT_10,OPT_RESULT_11, OPT_RESULT_12, OPT_RESULT_13,
    OPT_RESULT_14, OPT_RESULT_15, OPT_RESULT_16,
    OPT_RESULT_17, OPT_RESULT_18, OPT_RESULT_19,
    OPT_RESULT_20,
