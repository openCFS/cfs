#ifndef FILE_THERMO_MECH_COUPLING_HH
...
namespace CoupledField
{
  ...
  class ThermoMechCoupling : public BasePairCoupling
  {
  public:
    //! Constructor
  ...
  protected:
	...
	//! Check non linear thermomechanical coupling
	bool nonLinThermoMechCoupling_;

	//! SubType of mechanic section
    //std::string subType_;
