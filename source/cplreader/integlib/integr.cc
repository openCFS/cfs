...
//     maxbnd[2]=0.218;
    ...
    ElemIntegr * ptElemIntegr=new ElemIntegr(Elem::ET_HEXA8);
...
void  calcacousrcterms2d_( double coordMat_fortran[2][4], double Nodal_dTijdxj_fortran[2][4],
    ...
    // quad1FE
    ElemIntegr * ptElemIntegr=new ElemIntegr(Elem::ET_QUAD4);
...
void  calccombustionsrcvectorsurf_( double coordMat_fortran[12], double Nodal_Vec_fortran[12],
    ...
    if ( elemType == Elem::ET_QUAD4 || elemType == Elem::ET_TRIA3 ) {
      DIM = 3;
    } 
    else if ( elemType == Elem::ET_LINE2 ) {
      DIM = 2;
    }
