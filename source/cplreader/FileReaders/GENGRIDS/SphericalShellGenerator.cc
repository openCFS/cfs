...
namespace CoupledField
{
                                           ...
                                           bool generateElems)
  {
    ...
    elemTypesOut[baseIdx] = Elem::ET_QUAD4;
    ...
    for(UInt i=0; i<numInnerElems_; i++) 
    {
      ...
      for(UInt layer=0; layer<numLayers_; layer++) 
      {
        ...
        if(makeQuadratic_)
        {
          ...
          elemTypes_.push_back(Elem::ET_PYRA13);
        }
        else
        {
          elemTypes_.push_back(Elem::ET_PYRA5);
        }
  ...
  void SphericalShellGenerator::MakeQuadraticQuads() 
  {
    ...
    for(UInt i=0, n=numInnerElems_*2; i<n; i++) 
    {
      ...
      if(makeSuperQuadratic_) 
      {
        ...
        elemTypes_[i] = Elem::ET_QUAD9;
      }
      else 
      {
        elemTypes_[i] = Elem::ET_QUAD8;
      }
