...
namespace OLAS {
  ...
  public:
    ...
    CRS_Matrix( Integer nrows, Integer ncols, const PreMatrix<T>& premat );
   ...
   void Transpose(int* col_ptr, int* row_ptr, T* data_ptr) const;
  ...
  private:
    ...
    //!                respectively
    static void QuickSort( Integer *const cols, T *const data,
