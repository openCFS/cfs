...
//	  std::cout << "Output_Testing: " <<filters[i]->GetName() << std::endl;
  //}
  ...
  //resMan->ShowActiveResult();
  //std::set<boost::uuids::uuid> results =  resMan->GetListofResults();  //delievers in this example list with one entry (fluidMechVelocity)
