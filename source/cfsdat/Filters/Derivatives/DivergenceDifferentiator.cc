...
void DivergenceDifferentiator::ReadScatteredData(CF::StdVector< CF::Vector<Double> > sourceCoords,
                                        CF::StdVector< CF::Vector<Double> > scatteredData)
{
...
#ifdef USE_CGAL
void DivergenceDifferentiator::KNNSearch_CGAL(const Vector<Double> globPoint,
...
#ifdef USE_FLANN
void DivergenceDifferentiator::KNNSearch_FLANN(const Vector<Double> globPoint,
      StdVector< Vector<Double> >& neighbors,
      StdVector< Double >& l2Distances,
      StdVector< Vector<Double> >& vectors,
