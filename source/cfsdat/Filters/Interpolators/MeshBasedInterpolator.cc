...
MeshBasedInterpolator::MeshBasedInterpolator(UInt numWorkers, CF::PtrParamNode config, str1::shared_ptr<ResultManager> resMan)
...
void MeshBasedInterpolator::FinishInit(){
  //first go up
...
void MeshBasedInterpolator::CreateDummyCfsParamNode(){
