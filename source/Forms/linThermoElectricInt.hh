...
class LinThermoElectricInt : public ADBInt
{
	public:

		/// Constructor
		LinThermoElectricInt(BaseMaterial* matData, SubTensorType type);
		
		/// 
		~LinThermoElectricInt();
...
#endif // FILE_LINTHERMOELECTRICINT
