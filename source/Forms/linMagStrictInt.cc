...
namespace CoupledField {
  ...
  //   calcAMat
  // ============
  void LinMagStrictInt::calcAMat( Matrix<Double> &aMat, UInt ip,
  ...
  //   calcDMat
  // ============
  void LinMagStrictInt::calcDMat(Matrix<Double> &dMat, const Elem* elem)
  {
    Matrix<Double> matMatrix;
    ptMaterial->GetTensor(matMatrix,MAGNETOSTRICTION_TENSOR,matDataType_,subTensorType_);
  ...
  //   Constructor
  // ============
  LinMagStrictInt::LinMagStrictInt(BaseMaterial* matData,
                                         SubTensorType type) 
  : ADBInt( matData, type ) {

    name_ = "LinMagStrictInt";
