...
//      std::cerr << "\tweights: " << weights << std::endl;
  ...
  void IntScheme::DefineTetPoints(){
	  ...
	  AddIntegrationSet(GAUSS_ECO, Elem::ST_TET, 1, 1, (Double*) a1);
	  ...
	  AddIntegrationSet(GAUSS_ECO, Elem::ST_TET, 2, 4, (Double*) a2);
	  ...
	  AddIntegrationSet(GAUSS_ECO, Elem::ST_TET, 3, 5, (Double*) a3);
	  ...
	  AddIntegrationSet(GAUSS_ECO, Elem::ST_TET, 4, 11, (Double*) a4);
	  ...
	  AddIntegrationSet(GAUSS_ECO, Elem::ST_TET, 5, 14, (Double*) a5);
	  ...
	  AddIntegrationSet(GAUSS_ECO, Elem::ST_TET, 6, 24, (Double*) a6);
	  ...
	  AddIntegrationSet(GAUSS_ECO, Elem::ST_TET, 7, 31, (Double*) a7);
	  ...
	  AddIntegrationSet(GAUSS_ECO, Elem::ST_TET, 8, 43, (Double*) a8);
