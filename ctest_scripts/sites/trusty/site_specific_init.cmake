...
"
=============================================================================
 Making a local copy of working copy since Fedora 18 uses different SVN...
=============================================================================
"
)

SET(OLD_WC_DIR "${SITE_BASE_DIR}/../../../CFS_FESPACE_NIGHTLY")
SET(DEV_DIR "${SITE_BASE_DIR}/../../../..")
SET(NEW_WC_DIR "${SITE_BASE_DIR}/../../../../CFS_FESPACE_NIGHTLY")
