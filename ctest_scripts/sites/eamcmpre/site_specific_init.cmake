...
#  SET(CTEST_BUILD_NAME "Update Testsuite simon")
#  SET(CTEST_SOURCE_DIRECTORY "$ENV{HOME}/code/simon_cfs-test")
#ELSE()
#  SET(CTEST_BUILD_NAME "Update Testsuite shared_opt")
#  SET(CTEST_SOURCE_DIRECTORY "$ENV{HOME}/code/shared_cfs-test")
#ENDIF()

SET(CTEST_BUILD_NAME "Update Testsuite")
SET(CTEST_SOURCE_DIRECTORY "$ENV{HOME}/code/cfs-test")
