...
IF(EXISTS "${CFS_BINARY}" AND
  ...
  file(GLOB SVNKIT_DIRECTORY "${CTEST_BINARY_DIRECTORY}/svnkit-*")
  FILE(REMOVE_RECURSE  ${SVNKIT_DIRECTORY})
  ...
  EXECUTE_PROCESS(
    COMMAND tar -cvzf "${NIGHTLY_ARCHIVES_DIR}/${HOSTNAME}_${TEST_NAME}.tgz" CFS_BUILD_NIGHTLY
