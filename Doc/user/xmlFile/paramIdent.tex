...
\hline confidenceIntervals & computes upper bounds of confidence intervals& provides information about the reliability of the identified parameters (only real parts!). Does not identify anything.\\
\hline 
\end{tabular} 
