...
<storeResults>
   ...
   <nodeResults type="mechVelocity" region="gap"/>
</storeResults>
\end{verbatim}
...
\begin{verbatim}
<storeResults>
   <nodeHistory type="mechVelocity" saveNodes="ptName"/>
</storeResults>
\end{verbatim}
...
points have to be defined (searched) using the element {\bf
  directivityNodes} in section {\bf $<$domain$>$}. Then the
...
\begin{verbatim}
   <storeResults>
      <elemHistory type="mechStress" saveElems="elName"/>
   </storeResults>
\end{verbatim}
