...
\begin{table}[ht]
  \begin{longtable}{c|c|c}
    ...
    name & \# of args. & description \\
    \noalign{\smallskip}\hline\noalign{\smallskip} 
    \verb#sample1D#     & 3 & interpolation of boundary condition values from 
 sample data files \\
  \end{longtable}
...
\begin{verbatim}
<bcsAndLoads>
  <dirichletInhom name="bcNode" value="10 * sin(2 * pi * 1e-3 * t)"/>
<bcsAndLoads>
\end{verbatim}
...
\begin{verbatim}
<bcsAndLoads>
  <dirichletInhom name="bcNode" value="10 * x * sin(2 * pi * 1e-3 * t)"/>
<bcsAndLoads>
\end{verbatim}
The usage of the \verb#if#-statement is as follows:
\begin{verbatim}
<bcsAndLoads>
