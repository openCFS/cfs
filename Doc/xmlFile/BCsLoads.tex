...
condition is used, e.g. for grounding an electrode (electric potential
= 0).
...
{\bf Inhomogeneous BCs}  are used for assigning a
  ...
  specific nodes (according to the section {\bf nodes} in {\bf
    $<$domain$>$}) and a value which has to be assigned to this node.
...
In the section {\bf $<$bcsAndLoads$>$} of the appropriate PDE in the
...
With inhomogeneous BCs, one has additionally to define the value by
...
the name of the time file after the attribute {\bf dynamics}:

\verb!<dirichletInHom name="nameBound3" value="-1.0" dynamics="timeFile"/>!
...
\verb!<dirichletHom   name="nameBound1" dof="XXX"/>!

\noindent
for the inhomogenous BC the command

\verb!   <dirichletInHom   name="nameBound1"  dof="XXX"/>!

\noindent
has to be called. Herein, {\bf XXX} stands for the name degrees of
freedom, e.g. in the mechanical PDE

\begin{verbatim}
<bcsAndLoads>
   <dirichletHom   name="leftBound"   dof="ux"/>
   <dirichletHom   name="leftBound"   dof="uy"/>
   <dirichletInHom name="rightBound"  dof="uy"  value="2.0"/>
   <load           name="centerPoint" dof="ux"  value="3.0"/>
</bcsAndLoads>
\end{verbatim}
...
charge.  The syntax of the {\bf load} command is equal to that of 
...
\verb!<load  name="nameBound1"  dof="XXX"/>!
