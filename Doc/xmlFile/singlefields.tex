...
\begin{verbatim}
<storeResults>
   <elemResults type="efield" region="elecst2d"/>
</storeResults>
\end{verbatim}

In the command {\bf $<$region$>$}, all areas in which the electric field has to
be calculated, must be listed. To calculate the electric energy, one
has to use the command 

\begin{verbatim}      
<storeResults>
   <elemResults type="energy" region="reg2"/>
</storeResults>
\end{verbatim}
...
<cfsSimulation xmlns="http://www.cfs++.org">
  ...
  <pdeList>
    <electrostatic>
      ...
      <storeResults>
        <elemResults type="efield"/>
        <elemResults type="energy"/>
      </storeResults>
...
\begin{verbatim}
   <nodeResults type="displacement" region="bar"/>
   <nodeResults type="velocity" region="bar"/>
   <nodeResults type="acceleration" region="bar"/>
\end{verbatim}
...
\begin{verbatim}      
<storeResults>
   <elemResults type="stress" region="bar"/>
</storeResults>
\end{verbatim}
...
The config-file command for storing (only) the pressure in the result
file is

\begin{verbatim}      
<storeResults>
   <nodeResults type="pressure" region="fluid1"/>
</storeResults>
\end{verbatim}
...
<cfsSimulation xmlns="http://www.cfs++.org">
   ...
   <domain>
      <region name="sphere" material="water"/>
      <nodes name="rad"/>
      <nodes name="savePt"/>
   </domain>
   ...
   <pdeList>
      <acoustic>
         <region name="sphere"/>
         <bcsAndLoads>
            <dirichletInhom name="rad" value="1" dynamics="sin2kHz_4Burst.dat"/>
         </bcsAndLoads>
      </acoustic>
   </pdeList>
   ...
   <transient> 
      ...
      <stepSaveEnd> 100  </stepSaveEnd>
      <stepSaveInc> 1    </stepSaveInc>
      <timeDataFile name="sin2kHz_4Burst.dat"/>  
   </transient>
...
\begin{verbatim}
<storeResults>
   <elemResults type="bfield" region="yoke"/>
</storeResults>
\end{verbatim}
...
\begin{verbatim}
<storeResults>
   <elemResults type="eddy" region="yoke"/>
</storeResults>
\end{verbatim}
...
\begin{verbatim}
<storeResults>
   <elemResults type="energy" region="yoke"/>
</storeResults>
\end{verbatim}
...
<cfsSimulation xmlns="http://www.cfs++.org">
   ...
   <pdeList>
      <magnetic>
         ...
         <storeResults>
            <elemResults type="bfield" region="myCoil"/>
            <elemResults type="bfield" region="iron"/>
            <elemResults type="bfield" region="air"/>
         </storeResults>
