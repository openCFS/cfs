...
numFreq & $\nat$ & specifies the number of frequencies for which
                   a simulation is to be performed\\
\noalign{\smallskip}\hline\noalign{\smallskip}
startFreq & $> 0$ & smallest frequency for which a simulation is to be
                    performed\\
\noalign{\smallskip}\hline\noalign{\smallskip}
stopFreq & $\geqslant$ startFreq & largest frequency for which a simulation
                                   is to be performed\\
\noalign{\smallskip}\hline\noalign{\smallskip}
logSampling & yes, no & if this parameter is no or not specified, we perform
                        an equally spaced sampling of the interval
                        [startFreq, stopFreq]; if the parameter is set to
                        yes, we perform a logarithmic sampling\\
\noalign{\smallskip}\hline\noalign{\smallskip}
