...
For the documentation of parameter identification in piezoelectric equations see Chapter \ref{paramIdent}.
The analysistype multiharmonics is not yet implemented. Once it shall simulate the piezoelectric equations 
where the material parameters are a function of frequency.
%
%
