...
symStruct  & yes, no & Set to yes, if matrix has a symmetric pattern
                       of non-zero entries\\
\noalign{\smallskip}\hline\noalign{\smallskip}
ndOrdering & yes, no & If set to yes, pardiso will chose a nested dissection
                       approach for computing a fill-reducing re-ordering of
                       the matrx. Otherwise a minimum degree approach is
                       chosen.\\
\noalign{\smallskip}\hline\noalign{\smallskip}
logging    & yes, no & Currently not implemented\\
\noalign{\smallskip}\hline
\end{tabular}
\end{center}
%
